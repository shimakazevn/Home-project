...
[glink  color="btn_05_black"  storage="name.ks"  size="20"  text="はい"  x="430"  y="260"  width="471"  height="50"  _clickable_img=""  target="*yes"  ]
[glink  color="btn_05_black"  storage="name.ks"  size="20"  text="いいえ"  x="430"  y="370"  width="471"  height="50"  _clickable_img=""  target="*no"  ]
[s  ]
*no
...
[glink  color="btn_05_blue"  storage="name.ks"  size="20"  text="オープニングを見る"  x="430"  y="260"  width="471"  height="50"  _clickable_img=""  target="*noskip"  ]
[glink  color="btn_05_black"  storage="name.ks"  size="20"  text="スキップする"  x="430"  y="370"  width="471"  height="50"  _clickable_img=""  target="*skip"  ]
[s  ]
*noskip
