    ...
    setEvent: function (j_button, pm) {
            ...
            if (pm.disable !== "" && pm.disableimg != "") {
                ...
                if (prevFlg !== isFlag) {
                    ...
                    if (isFlag) {
                        if (pm.disableimg != "") {
                            parent_button.css({
                                "background-image": "url(data/image/" + pm.disableimg + ")",
                            })
                        }
                    } else {
                        parent_button.css({
        ...
        j_button.hover(
            function (ev) {
                ...
                if (pm.enterimg != "") {
                    parent_button.css({
                        "background-image": "url(data/image/" + pm.enterimg + ")",
                    })
                }
        ...
        j_button.on("click", function (ev) {
            ...
            if (that.kag.embScript(pm.disable)) {
                ...
                if (pm.clickimg != "") {
                    parent_button.css({
                        "background-image": "url(data/image/" + pm.clickimg + ")",
                    })
                }
...
tyrano.plugin.kag.tag.button_ex_restore = {
    ...
    start: function () {
        ...
        elms.each(function () {
            const trans = $(this).css("transition-duration")
            $(this).css({
