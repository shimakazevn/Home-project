...
[_tb_system_call storage=system/_H_nagi_R3_2.ks]
...
;右5　アナル攻め強
[button target=*5 enterimg=/H/HUI_anaruseme2_on.png clickimg=/H/HUI_anaruseme2_on.png x=840 y=16 graphic=/H/HUI_anaruseme2_on.png name="ui"]
...
[tb_start_tyrano_code]
;叩く（notloop）
[tb_image_show  time="1000"  storage="default/H/HR03_01_09_05.gif"]
[_tb_end_tyrano_code]
...
[call storage=H_serihu_nagi.ks target="*R3_2_supankingu_hit"]

[elsif exp="f.H_supankingu == 0"]
[call storage=H_serihu_nagi.ks target="*R3_2_supankingu1"]

[elsif exp="f.H_supankingu == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_supankingu2"]

[elsif exp="f.H_supankingu == 2"]
[call storage=H_serihu_nagi.ks target="*R3_2_supankingu3"]
...
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_02_02.gif"  ]
[tb_start_tyrano_code]
;胸揉み_ループパターン

[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_munemomi_hit"]

[elsif exp="f.H_munemomi == 0"]
[call storage=H_serihu_nagi.ks target="*R3_2_munemomi1"]

[elsif exp="f.H_munemomi == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_munemomi2"]

[elsif exp="f.H_munemomi == 2"]
[call storage=H_serihu_nagi.ks target="*R3_2_munemomi3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_03_02.gif"  ]
[tb_start_tyrano_code]
;乳首摘まみ_ループパターン

[if exp="f.H_hit == 5 && f.H_high3 == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_2_tikubitumami_hit"]

[elsif exp="f.H_tikubitumami == 0 "]
[call storage=H_serihu_nagi.ks target="*R3_2_tikubitumami1"]

[elsif exp="f.H_tikubitumami == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_2_tikubitumami2"]

[elsif exp="f.H_tikubitumami == 2 "]
[call storage=H_serihu_nagi.ks target="*R3_2_tikubitumami3"]
...
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_04_04.gif"  ]
[tb_start_tyrano_code]
;潮吹き_ループパターン

[if exp="f.H_hit == 5 && f.H_high4 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_siohuki_hit"]

[elsif exp="f.H_siohuki == 0 "]
[call storage=H_serihu_nagi.ks target="*R3_2_siohuki1"]

[elsif exp="f.H_siohuki == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_2_siohuki2"]

[elsif exp="f.H_siohuki == 2 "]
[call storage=H_serihu_nagi.ks target="*R3_2_siohuki3"]
...
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_06_07.gif"  ]
[tb_start_tyrano_code]
;アナルでループパターン

[if exp="f.H_hit == 5 && f.H_high5 == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_2_anarubizu_hit"]

[elsif exp="f.H_anarubizu == 0 "]
[call storage=H_serihu_nagi.ks target="*R3_2_anarubizu1"]

[elsif exp="f.H_anarubizu == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_2_anarubizu2"]

[elsif exp="f.H_anarubizu == 2 "]
[call storage=H_serihu_nagi.ks target="*R3_2_anarubizu3"]
...
[cm  ]
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[playse  volume="300"  time="1000"  buf="0"  storage="baibu.mp3"  loop="false"  clear="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_06_02.gif"  ]
[tb_start_tyrano_code]
;バイブループパターン

[if exp="f.H_hit == 5 && f.H_high6 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_baibu_hit"]

[elsif exp="f.H_baibu == 0"]
[call storage=H_serihu_nagi.ks target="*R3_2_baibu1"]

[elsif exp="f.H_baibu == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_baibu2"]

[elsif exp="f.H_baibu== 2"]
[call storage=H_serihu_nagi.ks target="*R3_2_baibu3"]
...
[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_nagi.ks target="*R3_2_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_2_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_nagi.ks target="*R3_2_kaiwa3"]
...
[cm  ]
[jump  storage="H_nagi_R3_2.ks"  target="*sounyu_skip"  cond="f.H_sounyu==1"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[tb_start_text mode=1 ]
[舜]「Vòi vĩnh thì phải làm sao nhỉ? Từ nãy đến giờ anh dạy dỗ nhiều lắm rồi mà?」[p]
[playse storage="nagi/voice_r3_2_nagi_sou1.mp3" buf="1"]Nagi「Vâng♡ Hãy đút con cu cứng ngắc... vào trong cô bé của em đi anh♡」[p]
[playse storage="nagi/voice_r3_2_nagi_sou2.mp3" buf="1"]Nagi「Hãy dùng cô bé của em... để làm cho con cu sướng đi anh♡ Dùng cái lỗ bạn thuở nhỏ này đi...♡」[p]
[舜]「Biết nói cả những lời dâm đãng thế này rồi cơ à... Thế thì ngậm cho chặt vào đấy nhé♡」[p]
[playse storage="nagi/voice_r3_2_nagi_sou3.mp3" buf="1"]Nagi「Aaaa♡ Ch-Chạm đến tận sâu bên trong rồiii...♡ Thế này thì, em lên đỉnh ngay mất thôiiii♡」[p]
[_tb_end_text]
...
[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_pisuton_yukkuri_hit"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 0"]
[call storage=H_serihu_nagi.ks target="*R3_2_pisuton_yukkuri1"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_pisuton_yukkuri2"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 2"]
[call storage=H_serihu_nagi.ks target="*R3_2_pisuton_yukkuri3"]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_nagi_R3_2.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_pisuton_hagesiku_hit"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 0"]
[call storage=H_serihu_nagi.ks target="*R3_2_pisuton_hagesiku1"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 1"]
[call storage=H_serihu_nagi.ks target="*R3_2_pisuton_hagesiku2"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 2"]
[call storage=H_serihu_nagi.ks target="*R3_2_pisuton_hagesiku3"]
...
[cm  ]
[tb_start_text mode=1 ]
[舜]「Bắn đây... anh sẽ bắn lên người em để đánh dấu đấy...!」[p]
Nagi「Cảm ơn anh nhiều lắm♡ Xin anh đấy♡ Hãy bắn tinh dịch nóng hổi sền sệt lên người em thật nhiều đi anh♡」[p]
Nagi「Hãy làm cho... chỉ cần nhìn thoáng qua là biết em là của anh Shun đi anh♡」[p]
[舜]「Khốn... ưm! Ra đây...! Bắn hết đây...!」[p]
[_tb_end_text]
...
[stopse  time="1000"  buf="3"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_nagi_R3_2.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
...
[tb_start_text mode=1 ]
Nagi「Hức♡ Ưm♡ A... tinh dịch sền sệt nóng hổi... bắn đầy lên người rồi...♡」[p]
[舜]「Mặt mũi đờ đẫn hết cả ra rồi kìa. Vui đến thế cơ à?」[p]
Nagi「Vui lắm ạ...♡ Vì em đang được cảm nhận anh Shun bằng toàn bộ cơ thể mà...♡」[p]
[_tb_end_text]

[tb_eval  exp="sf.Hresult_bukkake_nagi+=1"  name="Hresult_bukkake_nagi"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[l  ]
[jump  storage="H_nagi_R3_2.ks"  target="*end"  ]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Ưm♡ Aaa♡ Nóng quá...♡ Cứ như sắp bỏng đến nơi...♡」[p]
Nagi「Dùng em mà anh lại xuất tinh nhiều thế này...♡ Em vui lắm♡」[p]
Nagi「Hà, a... mùi nồng nặc quá...♡ Dù không nhìn thấy nhưng em biết là anh bắn ra nhiều lắm♡」[p]
[_tb_end_text]
...
[cm  ]
[tb_start_text mode=1 ]
[舜]「Hà... hà...! Sắp ra rồi đây...! Em muốn anh bắn vào đâu nào...!?」[p]
Nagi「V-Vào trong...! Cho em vào trong đi anh♡」[p]
[舜]「Em nghĩ chỉ nói thế là được cho à?」[p]
Nagi「Ưm♡ A♡ Em ngàn lần xin lỗi anh♡ Cho em... tinh dịch nóng hổi của anh Shun vào trong đi anh♡」[p]
Nagi「Hãy xuất tinh thật nhiều vào tận sâu bên trong... đến mức trào cả ra đi anh...!」[p]
[舜]「Nói giỏi lắm...! Bắn đây, nhận lấy tất cả đi...!」[p]
[_tb_end_text]
...
[wait  time="1500"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_nagi_R3_2.ks"  target="*syasei_nakadasi_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[stop_bgmovie  time="1000"  ]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Aaa♡ Vào tận sâu bên trong... phọt từng luồng rồi...♡ A♡ Ưm♡ Chạm đến nơi rồi♡」[p]
Nagi「Đầy ứ lên rồi...♡ Hà♡ Hà♡ Thứ nóng hổi... em nhận lấy tất cả rồi♡」[p]
Nagi「Được rót nhiều thế này em vui lắm♡ Hà, a... bên trong, vẫn đang giật giật liên hồi...♡」[p]
[_tb_end_text]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Ưm♡ Ooo♡ Tuyệt quá...♡ Trào ra mất...♡ Đầy tinh dịch rồi... sắp trào ra kìa♡」[p]
Nagi「Ưm♡ Nhưng mà, lãng phí lắm nên em sẽ nhận lấy đàng hoàng bên trong cơ thể mà♡」[p]
Nagi「Hà... hà...♡ Bây giờ bên trong em... đầy ứ ự mất rồi...♡」[p]
[_tb_end_text]
