...
[_tb_system_call storage=system/_H_3P_2.ks]
...
;右１　蕾にDキス
[button target=*1 enterimg=/H/HUI_Dkisstubomi.png clickimg=/H/HUI_Dkisstubomi_on.png x=1192 y=16 graphic=/H/HUI_Dkisstubomi_on.png]

;右２　凛子にDキス
[button target=*2 enterimg=/H/HUI_Dkissrinko.png clickimg=/H/HUI_Dkissrinko_on.png x=1104 y=16 graphic=/H/HUI_Dkissrinko_on.png name="ui"]

;右３　叩く
[button target=*3 enterimg=/H/HUI_siritataki2.png clickimg=/H/HUI_siritataki2_on.png x=1016 y=16 graphic=/H/HUI_siritataki2_on.png name="ui"]

;右４　素股
[button target=*4 enterimg=/H/HUI_sumata2.png clickimg=/H/HUI_sumata2_on.png x=928 y=16 graphic=/H/HUI_sumata2_on.png name="ui"]

;右5　手マン
[button target=*5 enterimg=/H/HUI_teman2.png clickimg=/H/HUI_teman2_on.png x=840 y=16 graphic=/H/HUI_teman2_on.png name="ui"]
...
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_Dkiss_tubomi2"]

[elsif exp="f.H_Dkiss == 2"]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_Dkiss_tubomi3"]
...
[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_Dkiss_rinko_hit"]
[elsif exp="f.H_Dkiss == 0"]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_Dkiss_rinko1"]

[elsif exp="f.H_Dkiss == 1"]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_Dkiss_rinko2"]

[elsif exp="f.H_Dkiss == 2"]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_Dkiss_rinko3"]
...
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_supankingu_hit"]

[elsif exp="f.H_supankingu == 0 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_supankingu1"]

[elsif exp="f.H_supankingu == 1 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_supankingu2"]

[elsif exp="f.H_supankingu == 2 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_supankingu3"]
...
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_sumata_hit"]

[elsif exp="f.H_sumata == 0 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_sumata1"]

[elsif exp="f.H_sumata == 1 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_sumata2"]

[elsif exp="f.H_sumata == 2 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_sumata3"]
...
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_teman2"]

[elsif exp="f.H_teman == 2 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_teman3"]
...
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_anaruseme_hit"]

[elsif exp="f.H_anaruseme == 0"]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_anaruseme1"]

[elsif exp="f.H_anaruseme == 1"]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_anaruseme2"]

[elsif exp="f.H_anaruseme == 2"]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_anaruseme3"]
...
[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_rinkotubomi.ks target="*3P_2_kaiwa3"]
...
[cm  ]
[jump  storage="H_3P_2.ks"  target="*sounyu_skip"  cond="f.H_sounyu==1"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[tb_start_text mode=1 ]
Tsubomi「Em đang dạng rộng hai chân ra rồi này♡ Em muốn anh đâm vào cơ♡ Đâm một phát vào tận sâu bên trong đi... Lấp đầy em bằng anh đi.」[p]
[舜]「Hai người hăng hái khoe cảnh làm tình cho nhau xem nhỉ... Hãy cho nhau xem bình thường lúc làm tình trông hai người có vẻ mặt thế nào đi.」[p]
Rinko「Phù♡ Phù♡ Em cũng không nhịn nổi nữa rồi♡ Em muốn anh Shun làm em sướng đến phát điên ngay bây giờ cơ.」[p]
[舜]「Theo thứ tự thôi... Đầu tiên anh sẽ thưởng thức cái khe dâm khít rịt của Tsubomi nhé...! Này, đón lấy đi♡」[p]
Tsubomi「A♡ Aaaa♡ Đang nong rộng ra rồi đâm vào này♡ Bên trong em bị lấp đầy mất rồi♡」[p]
[_tb_end_text]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_3P_2.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_3P_2.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
...
[l  ]
[jump  storage="H_3P_2.ks"  target="*end"  ]
...
[wait  time="3000"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_3P_2.ks"  target="*syasei_nakadasi_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[stop_bgmovie  time="1000"  ]
