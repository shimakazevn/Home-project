...
[_tb_system_call storage=system/_komyuhyouka_point_tubomi.ks]
...
[if exp="f.komyu_insyou_suki_tubomi == 0 "]
[call target="*sukiti_0"]

[elsif exp="f.komyu_insyou_suki_tubomi == 1 "]
[call target="*sukiti_1"]

[elsif exp="f.komyu_insyou_suki_tubomi == 2 "]
[call target="*sukiti_2"]

[elsif exp="f.komyu_insyou_suki_tubomi == 3 "]
[call target="*sukiti_3"]

[elsif exp="f.komyu_insyou_suki_tubomi == 4 "]
[call target="*sukiti_4"]

[elsif exp="f.komyu_insyou_suki_tubomi == 5 "]
[call target="*sukiti_5"]

[elsif exp="f.komyu_insyou_suki_tubomi == 6 "]
[call target="*sukiti_6"]

[elsif exp="f.komyu_insyou_suki_tubomi == 7 "]
[call target="*sukiti_7"]

[elsif exp="f.komyu_insyou_suki_tubomi == 8 "]
[call target="*sukiti_8"]

[elsif exp="f.komyu_insyou_suki_tubomi == 9 "]
[call target="*sukiti_9"]

[elsif exp="f.komyu_insyou_suki_tubomi == 10 "]
[call target="*sukiti_10"]

[elsif exp="f.komyu_insyou_suki_tubomi == 11 "]
[call target="*sukiti_11"]

[elsif exp="f.komyu_insyou_suki_tubomi >= 12 "]
...
[if exp="f.komyu_insyou_jyunsui_tubomi == 0 "]
[call target="*jyunsuiti_0"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 1 "]
[call target="*jyunsuiti_1"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 2 "]
[call target="*jyunsuiti_2"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 3 "]
[call target="*jyunsuiti_3"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 4 "]
[call target="*jyunsuiti_4"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 5 "]
[call target="*jyunsuiti_5"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 6 "]
[call target="*jyunsuiti_6"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 7 "]
[call target="*jyunsuiti_7"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 8 "]
[call target="*jyunsuiti_8"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 9 "]
[call target="*jyunsuiti_9"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 10 "]
[call target="*jyunsuiti_10"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi == 11 "]
[call target="*jyunsuiti_11"]

[elsif exp="f.komyu_insyou_jyunsui_tubomi >= 12 "]
...
[tb_eval  exp="f.komyu_insyou_suki_tubomi=12"  name="komyu_insyou_suki_tubomi"  cmd="="  op="t"  val="12"  val_2="undefined"  ]
[return  ]
*sukiti_m1
...
[tb_eval  exp="f.komyu_insyou_jyunsui_tubomi=12"  name="komyu_insyou_jyunsui_tubomi"  cmd="="  op="t"  val="12"  val_2="undefined"  ]
[return  ]
*jyunsuiti_m1
...
[chara_show  name="komyu_insyou"  time="0"  wait="true"  storage="chara/166/komyu_s_kirainaaite.png"  width="304"  height="144"  left="947"  top="10"  ]
[tb_eval  exp="f.kan_kirainaaite_tubomi=1"  name="kan_kirainaaite_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_sennouaite_tubomi=0"  name="kan_sennouaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_himetaomoi_tubomi=0"  name="kan_himetaomoi_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kininaruaite_tubomi=0"  name="kan_kininaruaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_tomodati_tubomi=0"  name="kan_tomodati_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_tuyoinikusimi_tubomi=0"  name="kan_tuyoinikusimi_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_mukansin_tubomi=0"  name="kan_mukansin_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_hukusyuaite_tubomi=0"  name="kan_hukusyuaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_mesitanoaite_tubomi=0"  name="kan_mesitanoaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*unmeinohito
...
[tb_eval  exp="f.kan_unmeinohito_tubomi=1"  name="kan_unmeinohito_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kininaruaite_tubomi=0"  name="kan_kininaruaite_tubomi"  cmd="="  op="t"  val="0"  ]
[return  ]
*kyouai
...
[tb_eval  exp="f.kan_kyouai_tubomi=1"  name="kan_kyouai_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_sennouaite_tubomi=0"  name="kan_sennouaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*keibetu
...
[tb_eval  exp="f.kan_keibetu_tubomi=1"  name="kan_keibetu_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_tuyoinikusimi_tubomi=0"  name="kan_tuyoinikusimi_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*nikubenki
...
[tb_eval  exp="f.kan_nikubenki_tubomi=1"  name="kan_nikubenki_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_hukusyuaite_tubomi=0"  name="kan_hukusyuaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*kininaru
...
[tb_eval  exp="f.kan_kininaruaite_tubomi=1"  name="kan_kininaruaite_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kirainaaite_tubomi=0"  name="kan_kirainaaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_himetaomoi_tubomi=0"  name="kan_himetaomoi_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_tomodati_tubomi=0"  name="kan_tomodati_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_unmeinohito_tubomi=0"  name="kan_unmeinohito_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*sennou
...
[tb_eval  exp="f.kan_sennouaite_tubomi=1"  name="kan_sennouaite_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kirainaaite_tubomi=0"  name="kan_kirainaaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_himetaomoi_tubomi=0"  name="kan_himetaomoi_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_mesitanoaite_tubomi=0"  name="kan_mesitanoaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kyouai_tubomi=0"  name="kan_kyouai_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*nikusimi

[chara_hide  name="komyu_insyou"  time="0"  wait="true"  pos_mode="false"  ]
[chara_show  name="komyu_insyou"  time="0"  wait="true"  storage="chara/166/komyu_s_tuyoinikusimi.png"  width="311"  height="146"  left="947"  top="10"  reflect="false"  ]
[tb_eval  exp="f.kan_tuyoinikusimi_tubomi=1"  name="kan_tuyoinikusimi_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kirainaaite_tubomi=0"  name="kan_kirainaaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_tomodati_tubomi=0"  name="kan_tomodati_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_mukansin_tubomi=0"  name="kan_mukansin_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_keibetu_tubomi=0"  name="kan_keibetu_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*hukusyuu
...
[tb_eval  exp="f.kan_hukusyuaite_tubomi=1"  name="kan_hukusyuaite_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kirainaaite_tubomi=0"  name="kan_kirainaaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_mesitanoaite_tubomi=0"  name="kan_mesitanoaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_mukansin_tubomi=0"  name="kan_mukansin_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_nikubenki_tubomi=0"  name="kan_nikubenki_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*himetaomoi

[chara_hide  name="komyu_insyou"  time="0"  wait="true"  pos_mode="false"  ]
[chara_show  name="komyu_insyou"  time="0"  wait="true"  storage="chara/166/komyu_s_himetaomoi.png"  width="304"  height="144"  left="947"  top="10"  reflect="false"  ]
[tb_eval  exp="f.kan_himetaomoi_tubomi=1"  name="kan_himetaomoi_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kirainaaite_tubomi=0"  name="kan_kirainaaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_sennouaite_tubomi=0"  name="kan_sennouaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kininaruaite_tubomi=0"  name="kan_kininaruaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
...
[chara_hide  name="komyu_insyou"  time="0"  wait="true"  pos_mode="false"  ]
[chara_show  name="komyu_insyou"  time="0"  wait="true"  storage="chara/166/komyu_s_mesita.png"  width="304"  height="144"  left="947"  top="10"  reflect="false"  ]
[tb_eval  exp="f.kan_mesitanoaite_tubomi=1"  name="kan_mesitanoaite_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kirainaaite_tubomi=0"  name="kan_kirainaaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_sennouaite_tubomi=0"  name="kan_sennouaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_hukusyuaite_tubomi=0"  name="kan_hukusyuaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*mukansin
...
[tb_eval  exp="f.kan_mukansin_tubomi=1"  name="kan_mukansin_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kirainaaite_tubomi=0"  name="kan_kirainaaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_hukusyuaite_tubomi=0"  name="kan_hukusyuaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_tuyoinikusimi_tubomi=0"  name="kan_tuyoinikusimi_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
*tomodati
...
[tb_eval  exp="f.kan_tomodati_tubomi=1"  name="kan_tomodati_tubomi"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.kan_kirainaaite_tubomi=0"  name="kan_kirainaaite_tubomi"  cmd="="  op="t"  val="0"  ]
[tb_eval  exp="f.kan_kininaruaite_tubomi=0"  name="kan_kininaruaite_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.kan_tuyoinikusimi_tubomi=0"  name="kan_tuyoinikusimi_tubomi"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[return  ]
