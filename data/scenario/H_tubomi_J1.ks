...
[_tb_system_call storage=system/_H_tubomi_J1.ks]
...
[jump  storage="H_tubomi_J1_2.ks"  target="*top"  cond="f.Hresult_kaihatuLV0_tubomi>999"  ]
...
[playse storage="tubomi/voice_j_tubomi_kaisi2.mp3" buf="2"] [舜]「Tsubomi, hôm nay tiếp tục luyện tập chứ?」[p]
[_tb_end_text]
...
;右４　胸舐め
[button target=*4 enterimg=/H/HUI_munename.png clickimg=/H/HUI_munename_on.png x=928 y=16 graphic=/H/HUI_munename_on.png name="ui"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_01_01.gif"  ]
[tb_start_tyrano_code]
;キスループパターン

[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_kiss_hit"]

[elsif exp="f.H_kiss == 0"]
[call storage=H_serihu_tubomi.ks target="*J1_kiss1"]

[elsif exp="f.H_kiss == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_kiss2"]

[elsif exp="f.H_kiss == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_kiss3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_60_01.gif"  ]
[tb_start_tyrano_code]
;パイズリ_ループパターン

[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_paizuri_hit"]

[elsif exp="f.H_paizuri == 0"]
[call storage=H_serihu_tubomi.ks target="*J1_paizuri1"]

[elsif exp="f.H_paizuri == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_paizuri2"]

[elsif exp="f.H_paizuri == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_paizuri3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_02_01.gif"  ]
[tb_start_tyrano_code]
;胸揉み_ループパターン

[if exp="f.H_hit == 5 && f.H_high3 == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_munemomi_hit"]

[elsif exp="f.H_munemomi == 0 "]
[call storage=H_serihu_tubomi.ks target="*J1_munemomi1"]

[elsif exp="f.H_munemomi == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_munemomi2"]

[elsif exp="f.H_munemomi == 2 "]
[call storage=H_serihu_tubomi.ks target="*J1_munemomi3"]
...
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  loop="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_02_03.gif"  ]
[tb_start_tyrano_code]
;胸舐め_ループパターン

[if exp="f.H_hit == 5 && f.H_high4 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_munename_hit"]

[elsif exp="f.H_munename == 0 "]
[call storage=H_serihu_tubomi.ks target="*J1_munename1"]

[elsif exp="f.H_munename == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_munename2"]

[elsif exp="f.H_munename == 2 "]
[call storage=H_serihu_tubomi.ks target="*J1_munename3"]
...
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  loop="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_05_03.gif"  ]
[tb_start_tyrano_code]
;クンニ_ループパターン

[if exp="f.H_hit == 5 && f.H_high5 == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_kunni_hit"]

[elsif exp="f.H_kunni == 0 "]
[call storage=H_serihu_tubomi.ks target="*J1_kunni1"]

[elsif exp="f.H_kunni == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_kunni2"]

[elsif exp="f.H_kunni == 2 "]
[call storage=H_serihu_tubomi.ks target="*J1_kunni3"]
...
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  loop="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_04_01.gif"  ]
[tb_start_tyrano_code]
;手マンループパターン

[if exp="f.H_hit == 5 && f.H_high6 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_teman_hit"]

[elsif exp="f.H_teman == 0"]
[call storage=H_serihu_tubomi.ks target="*J1_teman1"]

[elsif exp="f.H_teman == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_teman2"]

[elsif exp="f.H_teman == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_teman3"]
...
[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_tubomi.ks target="*J1_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_tubomi.ks target="*J1_kaiwa3"]
...
[cm  ]
[jump  storage="H_tubomi_J1.ks"  target="*sounyu_skip"  cond="f.H_sounyu==1"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[tb_start_text mode=1 ]
[playse storage="tubomi/voice_j1_1_tubomi_sou1.mp3" buf="2"] Tsubomi「Vâng ạ! Em sẵn sàng rồi!」[p]
[舜]「Nào, tấn công thử xem」[p]
[playse storage="tubomi/voice_j1_1_tubomi_sou2.mp3" buf="2"] Tsubomi「Hây a!」[p]
[舜]「Chậm quá!」[p]
[playse storage="tubomi/voice_j1_1_tubomi_sou3.mp3" buf="2"] Tsubomi「Á!」[p]
[_tb_end_text]
...
[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_pisuton_yukkuri_hit"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 0"]
[call storage=H_serihu_tubomi.ks target="*J1_pisuton_yukkuri1"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_pisuton_yukkuri2"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_pisuton_yukkuri3"]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_tubomi_J1.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_pisuton_hagesiku_hit"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 0"]
[call storage=H_serihu_tubomi.ks target="*J1_pisuton_hagesiku1"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_pisuton_hagesiku2"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_pisuton_hagesiku3"]
...
[cm  ]
[tb_start_text mode=1 ]
[舜]「A, chết tiệt… Tsubomi, xin lỗi em, anh sắp…!」[p]
Tsubomi「Đau quá à… Anh [舜] chẳng chịu nương tay gì cả…」[p]
Tsubomi「Bắn ra đi anh…♡ Bắn vào chỗ nào anh thích cũng được… Em sẽ đón nhận tất cả mà…♡」[p]
[舜]「Ư… Nghe em nói thế thì… anh không nhịn nổi nữa đâu! Anh bắn lên người em nhé…! A, ra mất rồi!」[p]
[_tb_end_text]

[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[stopse  time="1000"  buf="4"  fadeout="true"  ]
[jump  storage="H_tubomi_J1.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
...
[tb_start_text mode=1 ]
Tsubomi「Hiuuu♡ Nóng quá… Haa, aah… Mùi đàn ông nồng nàn quá đi…♡ Phù, đầu óc em quay cuồng hết cả rồi♡」[p]
Tsubomi「Aah… Mùi hương này mà dính lên người chắc còn lâu mới bay hết được quá♡ Mỗi lần ngửi thấy là em lại nhớ lại tất cả cho coi♡」[p]
Tsubomi「Ư… tay anh… chạm vào đâu thế…」[p]
[_tb_end_text]

[tb_eval  exp="sf.Hresult_bukkake_tubomi+=1"  name="Hresult_bukkake_tubomi"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[l  ]
[jump  storage="H_tubomi_J1.ks"  target="*end"  ]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Tsubomi「Aaaa♡ Tinh dịch nóng hổi bắn lên người em nhiều quá… Haa, ưm♡ Nhơm nhớp hết cả người rồi nè…♡」[p]
[舜]「Hà, hà, hà… Xin lỗi nhé, anh lỡ bắn tung tóe bẩn hết cả rồi… Lại phải dọn dẹp lại từ đầu thôi…」[p]
Tsubomi「Phù, haa, haah… Mấy chuyện đó không quan trọng đâu mà…♡ Em muốn anh… ôm chặt lấy em thêm một chút nữa cơ…♡」[p]
[_tb_end_text]
...
[cm  ]
[tb_start_text mode=1 ]
Tsubomi「K-Không có mà…!」[p]
[舜]「Ư… Sao em lại biết được chứ…! Hà, hà, anh sắp ra rồi…」[p]
Tsubomi「A… ưm… anh [舜]…」[p]
[舜]「Chỗ này… bắt đầu nóng lên rồi đấy」[p]
[_tb_end_text]
...
[playse  volume="100"  time="1000"  buf="0"  storage="H_syasei.mp3"  ]
[wait  time="1500"  ]
[jump  storage="H_tubomi_J1.ks"  target="*syasei_nakadasi_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[stop_bgmovie  time="1000"  ]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Tsubomi「Đừng mà… em không tập trung được mất…」[p]
Tsubomi「A♡ Aah♡ Trong này cặc anh vẫn còn đang giật nảy lên này♡ Cảm giác như… toàn bộ cơ thể em đã bị anh biến thành của riêng vậy♡」[p]
Tsubomi「Chuyện… khác ư…?」[p]
[_tb_end_text]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Tsubomi「Hyaaa♡ Auuu♡ B-Bên trong… căng phồng hết cả lên rồi nè♡ Tự dưng anh lại bắn ra một lượng khủng khiếp thế này chứ♡」[p]
Tsubomi「Ưm ưm♡ Haa♡ Haa♡ Chứa không hết nổi đâu, trào hết cả ra ngoài rồi nèeee♡」[p]
Tsubomi「Vâng ạ... anh [舜]... làm em sướng đi mà...」[p]
[_tb_end_text]
