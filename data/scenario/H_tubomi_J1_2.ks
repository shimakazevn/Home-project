...
[_tb_system_call storage=system/_H_tubomi_J1_2.ks]
...
[bg  time="0"  method="crossfade"  storage="H/HJ01_02_00_00.gif"  ]
...
[playse storage="tubomi/voice_j_tubomi_kaisi2.mp3" buf="2"] Tsubomi「Hôm nay... hãy cùng làm thật nhiều chuyện ngọt ngào nhé♡ Em đã chuẩn bị sẵn sàng hết rồi mà♡」[p]
[_tb_end_text]
...
*kirikae_low
;ボタン切り替え（低）
[jump storage="H_tubomi_J1.ks" target=*top2]

*kirikae_high
;ボタン切り替え（高）
[jump storage="H_tubomi_J1_2.ks" target=*top2]
[_tb_end_tyrano_code]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_01_02.gif"  ]
[tb_start_tyrano_code]
;Dキス_ループパターン

[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_Dkiss_hit"]

[elsif exp="f.H_kiss == 0"]
[call storage=H_serihu_tubomi.ks target="*J1_2_Dkiss1"]

[elsif exp="f.H_kiss == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_Dkiss2"]

[elsif exp="f.H_kiss == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_2_Dkiss3"]
...
[cm  ]
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="2"  storage="tubomi/voice_j_tubomi_fera.mp3"  loop="true"  clear="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_50_01.gif"  ]
[tb_start_tyrano_code]
;フェラ_ループパターン

[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_fera_hit"]

[elsif exp="f.H_fera == 0"]
[call storage=H_serihu_tubomi.ks target="*J1_2_fera1"]

[elsif exp="f.H_fera == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_fera2"]

[elsif exp="f.H_fera == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_2_fera3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_02_02.gif"  ]
[tb_start_tyrano_code]
;胸揉み_ループパターン

[if exp="f.H_hit == 5 && f.H_high3 == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_munemomi_hit"]

[elsif exp="f.H_munemomi == 0 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_munemomi1"]

[elsif exp="f.H_munemomi == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_munemomi2"]

[elsif exp="f.H_munemomi == 2 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_munemomi3"]
...
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_02_04.gif"  ]
[tb_start_tyrano_code]
;胸舐め_ループパターン

[if exp="f.H_hit == 5 && f.H_high4 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_munename_hit"]

[elsif exp="f.H_munename == 0 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_munename1"]

[elsif exp="f.H_munename == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_munename2"]

[elsif exp="f.H_munename == 2 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_munename3"]
...
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman2.mp3"  loop="true"  ]
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_05_04.gif"  ]
[tb_start_tyrano_code]
;膣舐め_ループパターン

[if exp="f.H_hit == 5 && f.H_high5 == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_tituname_hit"]

[elsif exp="f.H_tituname == 0 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_tituname1"]

[elsif exp="f.H_tituname == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_tituname2"]

[elsif exp="f.H_tituname == 2 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_tituname3"]
...
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_04_04.gif"  ]
[tb_start_tyrano_code]
;潮吹きループパターン

[if exp="f.H_hit == 5 && f.H_high6 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_siohuki_hit"]

[elsif exp="f.H_siohuki == 0"]
[call storage=H_serihu_tubomi.ks target="*J1_2_siohuki1"]

[elsif exp="f.H_siohuki == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_siohuki2"]

[elsif exp="f.H_siohuki == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_2_siohuki3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_02_00_01.gif"  ]
[tb_start_tyrano_code]
;会話_ループパターン

[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_tubomi.ks target="*J1_2_kaiwa3"]
...
[cm  ]
[jump  storage="H_tubomi_J1_2.ks"  target="*sounyu_skip"  cond="f.H_sounyu==1"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[tb_start_text mode=1 ]
[playse storage="tubomi/voice_j1_2_tubomi_sou1.mp3" buf="2"]Tsubomi「Hà... hà...♡ Nó đang từ từ tiến vào trong kìa... To quá... Căng tức cả người em rồi...♡」[p]
[playse storage="tubomi/voice_j1_2_tubomi_sou2.mp3" buf="2"]Tsubomi「N-Nếu vào tới tận sâu nhất... chắc bụng em sẽ bị nghiền nát mất thôi...♡」[p]
[舜]「Không sao đâu mà. Nào, thả lỏng người ra... anh sẽ từ từ đút vào. Ưm, hà, a, a...」[p]
[playse storage="tubomi/voice_j1_2_tubomi_sou3.mp3" buf="2"]Tsubomi「A... a... a...♡ Trơn tuột... lọt vào trong rồi kìa♡ To lớn quá... bên trong bị nong căng hết cả ra rồi♡」[p]
[舜]「A, hẹp quá... Bên trong khít rịt thế này... Chắc phải từ từ làm cho quen dần mới được...」[p]
[_tb_end_text]
...
[call storage="H_tubomi_cam.ks" target=*J1_cam1_yukkuri]
[elsif exp="f.H_pisutonspeed== 1"]
[call storage="H_tubomi_cam.ks" target=*J1_cam1_hagesiku]
[endif]
...
;スピード別の画像を表示
[if exp="f.H_pisutonspeed== 0"]
[call storage="H_tubomi_cam.ks" target=*J1_cam2_yukkuri]
[elsif exp="f.H_pisutonspeed== 1"]
[call storage="H_tubomi_cam.ks" target=*J1_cam2_hagesiku]
[endif]
...
[call storage=H_serihu_tubomi.ks target="*J1_2_pisuton_yukkuri1"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_pisuton_yukkuri2"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_2_pisuton_yukkuri3"]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_tubomi_J1_2.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_pisuton_hagesiku_hit"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 0"]
[call storage=H_serihu_tubomi.ks target="*J1_2_pisuton_hagesiku1"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 1"]
[call storage=H_serihu_tubomi.ks target="*J1_2_pisuton_hagesiku2"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 2"]
[call storage=H_serihu_tubomi.ks target="*J1_2_pisuton_hagesiku3"]
...
[cm  ]
[tb_start_text mode=1 ]
Tsubomi「A... a...♡ Nó nở to căng phồng lên rồi kìa♡ Hà, ưm... Muốn bắn ra nên đang rạo rực lắm rồi đúng không♡」[p]
Tsubomi「Đừng có nhịn mà hãy bắn ra đi... Em muốn anh trút hết toàn bộ vào em cơ♡ Cho em hết đi mà♡ Bạn gái của anh là em cơ mà đúng không?」[p]
[舜]「Đúng thế...! Anh chỉ muốn Tsubomi thôi...! Hà, hà, ưm! Em muốn anh bắn vào đâu?」[p]
Tsubomi「Hãy bắn lên khắp người em đi...♡ Hãy lưu lại mùi hương của anh [舜] trên người em đi...♡」[p]
[舜]「Phù, phù... Anh biết rồi! A, sắp ra rồi... Ra đây, ra ra ra! A, a... a...!」[p]
[_tb_end_text]

[stopse  time="1000"  buf="3"  ]
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_tubomi_J1_2.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_syasei.mp3"  ]
[stop_bgmovie  time="1000"  ]
[bg  time="0"  method="crossfade"  storage="H/HJ01_02_G3.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Tsubomi「Hức... a... a...♡ A... a...♡ Ôi... Tinh trùng bắn ngập tràn lên người em rồi...♡ Trắng xóa hết cả người rồi nè♡」[p]
[舜]「A... a... Phải chứng minh cho mọi người thấy Tsubomi là người của ai mới được chứ...!」[p]
Tsubomi「Ưm...♡ Không cần làm thế thì em cũng đã là người của anh từ lâu rồi mà♡」[p]
[_tb_end_text]

[tb_eval  exp="sf.Hresult_bukkake_tubomi+=1"  name="Hresult_bukkake_tubomi"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[l  ]
[jump  storage="H_tubomi_J1_2.ks"  target="*end"  ]
*syasei_karada_tairyou

[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_syasei.mp3"  ]
[stop_bgmovie  time="1000"  ]
[bg  time="0"  method="crossfade"  storage="H/HJ01_02_G4.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
