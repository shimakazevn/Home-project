...
[call  storage="ui_onoff.ks"  target="*tension_UP"  ]
[tb_start_text mode=1 ]
[font color="yellow"]Dũng khí đã tăng một chút[resetfont][r][font color="yellow"]Đã thanh toán 5000 Yên[resetfont][p]
[_tb_end_text]
...
[call  storage="ui_parameter.ks"  target="*money_update"  ]
[tb_start_text mode=1 ]
（Chỉ là bít tết ở quán gia đình thôi mà sao lại ngon thế này chứ... Tuyệt cú mèo）[p]
Bụng đã no căng rồi.[p]
[_tb_end_text]

[tb_start_text mode=1 ]
[font color="yellow"]Cơ bắp đã tăng[resetfont][r][font color="yellow"]Chỉ số Hưng phấn đã tăng mạnh[resetfont][r][font color="yellow"]Đã thanh toán 10000 Yên[resetfont][p]
[_tb_end_text]
