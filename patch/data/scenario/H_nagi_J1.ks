[_tb_system_call storage=system/_H_nagi_J1.ks]
...
[jump  storage="H_nagi_J1_2.ks"  target="*top"  cond="f.Hresult_kaihatuLV0_nagi>999"  ]
...
;右１　キス
[button target=*kiss enterimg=/H/HUI_kiss0.png clickimg=/H/HUI_kiss0_on.png x=1192 y=16 graphic=/H/HUI_kiss0_on.png name="ui"]

;右２　胸揉み
[button target=*munemomi enterimg=/H/HUI_munemomi0.png clickimg=/H/HUI_munemomi0_on.png x=1104 y=16 graphic=/H/HUI_munemomi0_on.png name="ui"]

;右３　乳首舐め
[button target=*tikubiname enterimg=/H/HUI_tikubiname.png clickimg=/H/HUI_tikubiname_on.png x=1016 y=16 graphic=/H/HUI_tikubiname_on.png name="ui"]

;右４　ふとももを撫でる
[button target=*naderu enterimg=/H/HUI_hutomomonade.png clickimg=/H/HUI_hutomomonade_on.png x=928 y=16 graphic=/H/HUI_hutomomonade_on.png name="ui"]

;右5　クンニ
[button target=*kunni enterimg=/H/HUI_kunni.png clickimg=/H/HUI_kunni_on.png x=840 y=16 graphic=/H/HUI_kunni_on.png name="ui"]

;右6　脚舐め
[button target=*asiname enterimg=/H/HUI_asiuraname.png clickimg=/H/HUI_asiuraname_on.png x=752 y=16 graphic=/H/HUI_asiuraname_on.png name="ui"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ01_01_03_03.gif"  ]
[tb_start_tyrano_code]
;乳首舐め_ループパターン

[if exp="f.H_hit == 5 && f.H_high3 == 1"]
[call storage=H_serihu_nagi.ks target="*J1_tikubiname_hit"]

[elsif exp="f.H_tikubiname == 0 "]
[call storage=H_serihu_nagi.ks target="*J1_tikubiname1"]

[elsif exp="f.H_tikubiname == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_tikubiname2"]

[elsif exp="f.H_tikubiname == 2 "]
[call storage=H_serihu_nagi.ks target="*J1_tikubiname3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ01_01_08_02.gif"  ]
[tb_start_tyrano_code]
;撫でる_ループパターン

[if exp="f.H_hit == 5 && f.H_high4 == 1"]
[call storage=H_serihu_nagi.ks target="*J1_naderu_hit"]

[elsif exp="f.H_naderu == 0 "]
[call storage=H_serihu_nagi.ks target="*J1_naderu1"]

[elsif exp="f.H_naderu == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_naderu2"]

[elsif exp="f.H_naderu == 2 "]
[call storage=H_serihu_nagi.ks target="*J1_naderu3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ01_01_01_01.gif"  ]
[tb_start_tyrano_code]
;キス_ループパターン

[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_nagi.ks target="*J1_kiss_hit"]

[elsif exp="f.H_kiss == 0 "]
[call storage=H_serihu_nagi.ks target="*J1_kiss1"]

[elsif exp="f.H_kiss == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_kiss2"]

[elsif exp="f.H_kiss == 2 "]
[call storage=H_serihu_nagi.ks target="*J1_kiss3"]
...
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_01_02_01.gif"  ]
[tb_start_tyrano_code]
;胸揉み_ループパターン

[if exp="f.H_hit == 5 && f.H_high2 == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_munemomi_hit"]

[elsif exp="f.H_munemomi == 0 "]
[call storage=H_serihu_nagi.ks target="*J1_munemomi1"]

[elsif exp="f.H_munemomi == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_munemomi2"]

[elsif exp="f.H_munemomi == 2 "]
[call storage=H_serihu_nagi.ks target="*J1_munemomi3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  loop="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_01_05_03.gif"  ]
[tb_start_tyrano_code]
;クンニ_ループパターン

[if exp="f.H_hit == 5 && f.H_high5 == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_kunni_hit"]

[elsif exp="f.H_kunni == 0 "]
[call storage=H_serihu_nagi.ks target="*J1_kunni1"]

[elsif exp="f.H_kunni == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_kunni2"]

[elsif exp="f.H_kunni == 2 "]
[call storage=H_serihu_nagi.ks target="*J1_kunni3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  loop="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_01_08_04.gif"  ]
[tb_start_tyrano_code]
;足舐めループパターン

[if exp="f.H_hit == 5 && f.H_high6 == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_asiname_hit"]

[elsif exp="f.H_asiname == 0 "]
[call storage=H_serihu_nagi.ks target="*J1_asiname1"]

[elsif exp="f.H_asiname == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_asiname2"]

[elsif exp="f.H_asiname == 2 "]
[call storage=H_serihu_nagi.ks target="*J1_asiname3"]
...
[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_nagi.ks target="*J1_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_nagi.ks target="*J1_kaiwa3"]
...
[cm  ]
[jump  storage="H_nagi_J1.ks"  target="*sounyu_skip"  cond="f.H_sounyu==1"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[tb_start_text mode=1 ]
[舜]「A~, anh muốn đâm vào quá rồi... Nagi này, anh đâm vào được không?」[p]
[playse storage="nagi/voice_j1_1_nagi_sou1.mp3" buf="1"]Nagi「Ưm... được mà... Hãy cắm con cu nóng rực của anh Shun vào đi...♡ Vì em là y tá mà...」[p]
[playse storage="nagi/voice_j1_1_nagi_sou2.mp3" buf="1"]Nagi「Chỗ nào bị sốt, em phải dùng cơ thể mình để chữa trị cho anh chứ...♡ Xin mời♡ Cứ sử dụng đi...」[p]
[舜]「Em trở nên dâm đãng thế này từ bao giờ vậy... Anh đâm vào đây... hự... ưm...!」[p]
[playse storage="nagi/voice_j1_1_nagi_sou3.mp3" buf="1"]Nagi「Aaaa♡ To quá... a♡ Aaaa♡ Vào tận sâu... bên trong rồi♡」[p]
[_tb_end_text]
...
[if exp="f.H_hit == 5 && f.H_high1 == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_pisuton_yukkuri_hit"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 0 "]
[call storage=H_serihu_nagi.ks target="*J1_pisuton_yukkuri1"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_pisuton_yukkuri2"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 2 "]
[call storage=H_serihu_nagi.ks target="*J1_pisuton_yukkuri3"]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_nagi_J1.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
[if exp="f.H_hit == 5 && f.H_high2 == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_pisuton_hagesiku_hit"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 0 "]
[call storage=H_serihu_nagi.ks target="*J1_pisuton_hagesiku1"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 1 "]
[call storage=H_serihu_nagi.ks target="*J1_pisuton_hagesiku2"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 2 "]
[call storage=H_serihu_nagi.ks target="*J1_pisuton_hagesiku3"]
...
[cm  ]
[tb_start_text mode=1 ]
[舜]「A~, ra mất... Anh bắn lên người Nagi được không? A, nhưng mà quần áo sẽ...」[p]
Nagi「Được mà, anh cứ bắn đi? Em muốn ngập ngụa trong tinh dịch của anh Shun cơ...♡」[p]
Nagi「Hơn nữa... kiểm tra tình trạng tinh dịch cũng là công việc của y tá mà, đúng không?」[p]
[舜]「Hự... Dâm quá rồi đấy...! A~, ra rồi...! Bắn bắn bắn đây!」[p]
[_tb_end_text]
...
[stopse  time="1000"  buf="3"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_nagi_J1.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
...
[tb_start_text mode=1 ]
Nagi「Ưm... a... hà, a... ấm quá... Em bị dính đầy tinh dịch mất rồi...♡」[p]
Nagi「Vừa nóng rực lại còn nhầy nhụa... Ưm, mùi hương và nhiệt độ đều không có gì bất thường nhé...」[p]
Nagi「Tinh dịch và con cu của anh đều rất khỏe mạnh đấy...♡ Khc, bắn ra nhiều thật nhỉ♡」[p]
[_tb_end_text]

[tb_eval  exp="sf.Hresult_bukkake_nagi+=1"  name="Hresult_bukkake_nagi"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[l  ]
[jump  storage="H_nagi_J1.ks"  target="*end"  ]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Á! Nh-Nhiều quá đi mất... a... Khắp người em nhầy nhụa hết rồi... Anh hưng phấn đến mức bắn ra nhiều thế này cơ à?」[p]
Nagi「Phù... lại còn đặc quánh nữa... Mùi đàn ông nồng nặc làm em muốn chóng mặt luôn rồi.」[p]
Nagi「Thế này thì... chắc phải kiểm tra lại nhỉ? Khc, em đùa thôi♡ Tinh dịch của anh vừa dâm đãng, đặc quánh, lại còn rất tốt nữa.」[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
[舜]「Bắn... anh ra mất...!」[p]
Nagi「Bắn vào trong đi... Anh sẽ tiêm cho em mà, đúng không?」[p]
Nagi「Em muốn anh... lấp đầy bên trong em... Hãy dùng mũi tiêm này chữa khỏi cơn ngứa ngáy trong cơ thể em đi♡」[p]
[舜]「Y tá mà lại vòi vĩnh đòi tiêm sao? Hết cách với em rồi... Anh bắn hết ra đây...! Bắn, bắn bắn ra mất...!」[p]
[_tb_end_text]
...
[wait  time="1500"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_nagi_J1.ks"  target="*syasei_nakadasi_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[stop_bgmovie  time="1000"  ]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Aaaa♡ Thuốc ấm quá... Bắn đầy vào trong bụng em rồi...♡」[p]
Nagi「Ưm, phù, phù, thuốc chảy tuột vào tận sâu bên trong cơ thể... ưm, nóng rực lên rồi này♡」[p]
Nagi「Bác sĩ ơi... cảm ơn anh vì mũi tiêm nhé♡」[p]
[_tb_end_text]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Hí♡ A, nhiều quá đi mất... Thế này thì, cô bé của em hỏng mất thôi...!」[p]
[舜]「Để thuốc trào ra ngoài cũng không sao đúng không?」[p]
Nagi「Kh-Không được... em sẽ uống cạn hết mà...♡ Ưm, ưm, cô bé của em bị lấp đầy mất rồi...♡」[p]
[_tb_end_text]
