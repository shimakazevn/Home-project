...
[_tb_system_call storage=system/_komyuhyouka_tubomi.ks]
...
[bg  time="0"  method="crossfade"  storage="komyu_insyou1.png"  cross="false"  ]
[call  storage="system.ks"  target="*fade_out"  ]
[call  storage="komyuhyouka_point_tubomi.ks"  target="*top"  ]
[cm  ]
[tb_start_tyrano_code]
;ボタン表示（好き）
...
[tb_eval  exp="f.komyu_insyou_suki_tubomi+=1"  name="komyu_insyou_suki_tubomi"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[call  storage="komyuhyouka_point_tubomi.ks"  target="*top"  ]
[tb_start_tyrano_code]
;ボタン表示（好き）戻る
...
[tb_eval  exp="f.komyu_insyou_suki_tubomi-=1"  name="komyu_insyou_suki_tubomi"  cmd="-="  op="t"  val="1"  val_2="undefined"  ]
[call  storage="komyuhyouka_point_tubomi.ks"  target="*top"  ]
[jump  storage="komyuhyouka_tubomi.ks"  target="*top"  ]
*kirai
...
[cm  ]
[chara_hide  name="komyu_hyouka"  time="0"  wait="true"  pos_mode="false"  ]
[tb_eval  exp="f.komyu_insyou_jyunsui_tubomi+=1"  name="komyu_insyou_jyunsui_tubomi"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[call  storage="komyuhyouka_point_tubomi.ks"  target="*top"  ]
[tb_start_tyrano_code]
;ボタン表示（純粋）戻る
