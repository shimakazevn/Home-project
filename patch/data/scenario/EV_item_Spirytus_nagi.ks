...
[glink  color="btn_05_black"  storage="EV_item_Spirytus_nagi.ks"  size="20"  x="416"  y="220"  width="425"  height="60"  text="Dùng viên Spirytus"  _clickable_img=""  target="*yes"  ]
[glink  color="btn_05_black"  storage="EV_item_Spirytus_nagi.ks"  size="20"  x="416"  y="340"  width="425"  height="60"  text="Không dùng"  _clickable_img=""  target="*no"  ]
[s  ]
*no
...
[call  storage="system.ks"  target="*fade_out"  ]
[tb_start_text mode=1 ]
[舜]（Canh lúc đối phương rời khỏi chỗ rồi dùng thử xem...）[p]
[_tb_end_text]
