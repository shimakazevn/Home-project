[_tb_system_call storage=system/_H_nagi_J2.ks]
...
[jump  storage="H_nagi_J2_2.ks"  target="*top"  cond="f.Hresult_kaihatuLV0_nagi>999"  ]
...
[playse storage="nagi/voice_nagi_kaisi3.mp3" buf="1"]Nagi「Người ngợm nhầy nhụa hết cả rồi... Khc, làm tình trong phòng tắm thế này cứ như đang làm chuyện xấu ấy nhỉ♡」[p]
[_tb_end_text]
...
;右１　キス
[button target=*kiss enterimg=/H/HUI_kiss0.png clickimg=/H/HUI_kiss0_on.png x=1192 y=16 graphic=/H/HUI_kiss0_on.png]

;右２　尻コキ
[button target=*sirikoki enterimg=/H/HUI_sirikoki.png clickimg=/H/HUI_sirikoki_on.png x=1104 y=16 graphic=/H/HUI_sirikoki_on.png name="ui"]

;右３　胸揉み
[button target=*munemomi enterimg=/H/HUI_munemomi0.png clickimg=/H/HUI_munemomi0_on.png x=1016 y=16 graphic=/H/HUI_munemomi0_on.png name="ui"]

;右４　尻撫で
[button target=*sirinade enterimg=/H/HUI_sirinade.png clickimg=/H/HUI_sirinade_on.png x=928 y=16 graphic=/H/HUI_sirinade_on.png name="ui"]

;右5　太腿撫で
[button target=*hutomomo enterimg=/H/HUI_hutomomonade.png clickimg=/H/HUI_hutomomonade_on.png x=840 y=16 graphic=/H/HUI_hutomomonade_on.png name="ui"]

;右6　手マン
[button target=*teman enterimg=/H/HUI_teman.png clickimg=/H/HUI_teman_on.png x=752 y=16 graphic=/H/HUI_teman_on.png name="ui"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ02_01_01_01.gif"  ]
[tb_start_tyrano_code]
;キス_ループパターン

[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_nagi.ks target="*J2_kiss_hit"]

[elsif exp="f.H_kiss == 0"]
[call storage=H_serihu_nagi.ks target="*J2_kiss1"]

[elsif exp="f.H_kiss == 1"]
[call storage=H_serihu_nagi.ks target="*J2_kiss2"]

[elsif exp="f.H_kiss == 2"]
[call storage=H_serihu_nagi.ks target="*J2_kiss3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ02_01_30_01.gif"  ]
[tb_start_tyrano_code]
;尻コキ_ループパターン

[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_nagi.ks target="*J2_sirikoki_hit"]

[elsif exp="f.H_sirikoki == 0"]
[call storage=H_serihu_nagi.ks target="*J2_sirikoki1"]

[elsif exp="f.H_sirikoki == 1"]
[call storage=H_serihu_nagi.ks target="*J2_sirikoki2"]

[elsif exp="f.H_sirikoki == 2"]
[call storage=H_serihu_nagi.ks target="*J2_sirikoki3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ02_01_02_01.gif"  ]
[tb_start_tyrano_code]
;胸揉み_ループパターン

[if exp="f.H_hit == 5 && f.H_high3 == 1 "]
[call storage=H_serihu_nagi.ks target="*J2_munemomi_hit"]

[elsif exp="f.H_munemomi == 0 "]
[call storage=H_serihu_nagi.ks target="*J2_munemomi1"]

[elsif exp="f.H_munemomi == 1 "]
[call storage=H_serihu_nagi.ks target="*J2_munemomi2"]

[elsif exp="f.H_munemomi == 2 "]
[call storage=H_serihu_nagi.ks target="*J2_munemomi3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ02_01_08_05.gif"  ]
[tb_start_tyrano_code]
;尻撫で_ループパターン

[if exp="f.H_hit == 5 && f.H_high4 == 1"]
[call storage=H_serihu_nagi.ks target="*J2_sirinade_hit"]

[elsif exp="f.H_sirinade == 0 "]
[call storage=H_serihu_nagi.ks target="*J2_sirinade1"]

[elsif exp="f.H_sirinade == 1 "]
[call storage=H_serihu_nagi.ks target="*J2_sirinade2"]

[elsif exp="f.H_sirinade == 2 "]
[call storage=H_serihu_nagi.ks target="*J2_sirinade3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ02_01_08_02.gif"  ]
[tb_start_tyrano_code]
;太もも撫でループパターン

[if exp="f.H_hit == 5 && f.H_high5 == 1 "]
[call storage=H_serihu_nagi.ks target="*J2_hutomomo_hit"]

[elsif exp="f.H_naderu == 0 "]
[call storage=H_serihu_nagi.ks target="*J2_hutomomo1"]

[elsif exp="f.H_naderu == 1 "]
[call storage=H_serihu_nagi.ks target="*J2_hutomomo2"]

[elsif exp="f.H_naderu == 2 "]
[call storage=H_serihu_nagi.ks target="*J2_hutomomo3"]
...
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  loop="true"  ]
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ02_01_04_01.gif"  ]
[tb_start_tyrano_code]
;手マンループパターン

[if exp="f.H_hit == 5 && f.H_high6 == 1"]
[call storage=H_serihu_nagi.ks target="*J2_teman_hit"]

[elsif exp="f.H_teman == 0"]
[call storage=H_serihu_nagi.ks target="*J2_teman1"]

[elsif exp="f.H_teman == 1"]
[call storage=H_serihu_nagi.ks target="*J2_teman2"]

[elsif exp="f.H_teman == 2"]
[call storage=H_serihu_nagi.ks target="*J2_teman3"]
...
[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_nagi.ks target="*J2_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_nagi.ks target="*J2_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_nagi.ks target="*J2_kaiwa3"]
...
[cm  ]
[jump  storage="H_nagi_J2.ks"  target="*sounyu_skip"  cond="f.H_sounyu==1"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[tb_start_text mode=1 ]
[舜]「Phù... đến giới hạn rồi... Anh đâm vào trong Nagi được không?」[p]
[playse storage="nagi/voice_j2_1_nagi_sou1.mp3" buf="1"]Nagi「Tới đi anh...♡ Cửa vào cũng đang ướt sũng nhầy nhụa rồi này...♡」[p]
[舜]「Thật này... a~, thế này thì đâm vào dễ ợt luôn... Anh vào nhé, hự... ưm♡」[p]
[playse storage="nagi/voice_j2_1_nagi_sou2.mp3" buf="1"]Nagi「Aaaa♡ Hà, hà... v-vào tận sâu... bên trong rồi♡ Ưm, đâm một phát vào sâu tít bên trong luôn rồi này♡」[p]
[_tb_end_text]
...
[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_nagi.ks target="*J2_pisuton_yukkuri_hit"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 0"]
[call storage=H_serihu_nagi.ks target="*J2_pisuton_yukkuri1"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 1"]
[call storage=H_serihu_nagi.ks target="*J2_pisuton_yukkuri2"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 2"]
[call storage=H_serihu_nagi.ks target="*J2_pisuton_yukkuri3"]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_nagi_J2.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_nagi.ks target="*J2_pisuton_hagesiku_hit"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 0"]
[call storage=H_serihu_nagi.ks target="*J2_pisuton_hagesiku1"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 1"]
[call storage=H_serihu_nagi.ks target="*J2_pisuton_hagesiku2"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 2"]
[call storage=H_serihu_nagi.ks target="*J2_pisuton_hagesiku3"]
...
[cm  ]
[tb_start_text mode=1 ]
[舜]「A... anh ra mất...! Bắn lên người Nagi... cũng được đúng không...! Cho nhầy nhụa luôn đi!」[p]
Nagi「Tới đi anh... Em muốn trộn lẫn lotion với tinh dịch của anh Shun cơ♡」[p]
Nagi「Em muốn phòng tắm ngập tràn mùi hương dâm đãng này...♡ Hãy bắn ra thật nhiều đi♡」[p]
[舜]「Em dâm quá rồi đấy...! Gư, ra, bắn bắn bắn đây...! Bắn...!」[p]
[_tb_end_text]
...
[stopse  time="1000"  buf="3"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_nagi_J2.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
...
[tb_start_text mode=1 ]
Nagi「A...♡ Aaa♡ Đồ ấm nóng... đang bắn lên người em này♡」[p]
Nagi「Ưm... mùi nồng quá...♡ Trộn với lotion, càng làm người nhầy nhụa hơn rồi này♡」[p]
Nagi「Hà... hà... ưm... Cả tâm trí lẫn cơ thể em, đều ngập tràn hình bóng anh Shun rồi♡」[p]
[_tb_end_text]

[tb_eval  exp="sf.Hresult_bukkake_nagi+=1"  name="Hresult_bukkake_nagi"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[l  ]
[jump  storage="H_nagi_J2.ks"  target="*end"  ]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Ưm...♡ A... b-bắn ra nhiều thế cơ à? Lưng và chân em... nóng rực hết cả lên rồi này...♡」[p]
Nagi「Cứ như bị dội nước nóng ấy... Tất cả chỗ này đều trào ra từ bên trong anh Shun sao...」[p]
Nagi「Hà, hà... em tắm trong tinh dịch của anh luôn rồi... Được đắm chìm trong mùi hương của anh Shun em vui lắm♡」[p]
[_tb_end_text]
...
[cm  ]
[tb_start_text mode=1 ]
Nagi「Hà♡ A... lên đỉnh... em lên đỉnh mất...♡」[p]
[舜]「Anh cũng lên đỉnh đây... hà, hà... anh muốn bắn vào trong... Lấp đầy... bên trong Nagi nhé...!」[p]
Nagi「Bắn đi anh...♡ Bên ngoài đã đủ nhầy nhụa rồi... em muốn bên trong cũng ngập ngụa cơ♡」[p]
[舜]「A... ra rồi... Bắn, bắn bắn bắn đây!」[p]
[_tb_end_text]
...
[wait  time="1500"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_nagi_J2.ks"  target="*syasei_nakadasi_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[stop_bgmovie  time="1000"  ]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Hiaaa♡ A... aaaa♡ Đồ nóng hổi... đang bắn vào trong rồi♡」[p]
Nagi「Đang ngập tràn bên trong rồi... ưm♡ Tinh dịch của anh Shun... nóng quá♡」[p]
Nagi「Em cảm nhận rõ bên trong đang nong rộng ra luôn này...♡」[p]
[_tb_end_text]
...
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Aaa...♡ Lượng tinh dịch, nhiều quá... hà, a, trào ra mất... ưm♡ Trào ra ngoài rồi...」[p]
[舜]「Có sao đâu, đằng nào cũng đang ở phòng tắm mà... Bị nhầy nhụa một chút cũng không sao đâu...」[p]
Nagi「Vậy sao♡ Hà, hà... làm tình trong phòng tắm... sướng thật đấy...♡」[p]
[_tb_end_text]
