...
[_tb_system_call storage=system/_sinnyu_rihure.ks]
...
[舜]（Phải nhanh chóng làm cho xong trước khi có người đến mới được.）
[_tb_end_text]

[wait  time="800"  ]
[jump  storage="sinnyu_rihure.ks"  target="*end"  cond="f.sinnyu_koudou_count==0"  ]
...
[bg  time="1000"  method="fadeIn"  storage="back_rihure_hikaesitu.png"  ]
[jump  storage="sinnyu_rihure_haiti.ks"  target="*top0"  ]
*bussyoku

[call  storage="sinnyu_item.ks"  target="*off"  ]
[jump  storage="sinnyu_rihure_bussyoku.ks"  target="*top"  ]
*end
