...
[jump  storage="job_kintore.ks"  target="*daiseikou"  cond="f.job_ransuu>9"  ]
[tb_start_tyrano_code]
;9/11で成功(テンション高い)
...
[cm  ]
[tb_eval  exp="f.job_ransuu=Math.floor(Math.random()*(11-1+1)+1)"  name="job_ransuu"  cmd="="  op="r"  val="1"  val_2="11"  ]
[jump  storage="job_kintore.ks"  target="*daiseikou"  cond="f.job_ransuu==1"  ]
[tb_start_tyrano_code]
;7/11で成功(テンションふつう)
...
[jump  storage="job_kintore.ks"  target="*byouki_skip"  cond="f.workanime==1"  ]
[call  storage="job_sd.ks"  target="*kintore1"  ]
*byouki_skip

[jump  storage="job_kintore.ks"  target="*end"  cond="f.job_count==0"  ]
[jump  storage="job_kintore.ks"  target="*sippai"  cond=""  ]
[jump  storage="job_kintore.ks"  target="*top"  ]
[jump  storage="job_kintore.ks"  target="*seikou"  cond="f.job_ransuu==0"  ]
*daiseikou
...
;UPエフェクト表示（筋力大up）
[image layer="0" x="988" y="-8" storage="default/r_up.gif" time="0"  name="UP" ]
[_tb_end_tyrano_code]

[tb_eval  exp="f.job_count-=1"  name="job_count"  cmd="-="  op="t"  val="1"  val_2="undefined"  ]
[jump  storage="job_kintore.ks"  target="*daiseikou_skip"  cond="f.workanime==1"  ]
[call  storage="job_sd.ks"  target="*kintore3"  ]
*daiseikou_return

[call  storage="job_ten_daiseikou.ks"  target="*kintore_daiseikou"  ]
[jump  storage="job_kintore.ks"  target="*end"  cond="f.job_count==0"  ]
[jump  storage="job_kintore.ks"  target="*top"  ]
*seikou
...
[tb_eval  exp="f.job_count-=1"  name="job_count"  cmd="-="  op="t"  val="1"  ]
[jump  storage="job_kintore.ks"  target="*seikou_skip"  cond="f.workanime==1"  ]
[call  storage="job_sd.ks"  target="*kintore2"  ]
*seikou_return

[call  storage="job_ten_hikui.ks"  target="*kintore_seikou"  ]
[jump  storage="job_kintore.ks"  target="*end"  cond="f.job_count==0"  ]
[jump  storage="job_kintore.ks"  target="*top"  ]
*sippai
...
[tb_eval  exp="f.job_count-=1"  name="job_count"  cmd="-="  op="t"  val="1"  ]
[jump  storage="job_kintore.ks"  target="*sippai_skip"  cond="f.workanime==1"  ]
[call  storage="job_sd.ks"  target="*kintore1"  ]
*sippai_return

[call  storage="job_ten_hikui.ks"  target="*kintore_sippai"  ]
[jump  storage="job_kintore.ks"  target="*end"  cond="f.job_count==0"  ]
[jump  storage="job_kintore.ks"  target="*top"  ]
*end
...
[wait  time="500"  ]
[jump  storage="job_moneyget_mesi.ks"  target="*top"  cond=""  ]
[s  ]
*daiseikou_skip

[playse  volume="100"  time="0"  buf="0"  storage="job_daiseikou.mp3"  ]
[chara_hide  name="job"  time="0"  wait="false"  pos_mode="false"  ]
[chara_show  name="job"  time="0"  wait="true"  storage="chara/169/job_kintore3.png"  width="496"  height="280"  left="368"  top="165"  ]
[wait  time="500"  ]
[jump  storage="job_kintore.ks"  target="*daiseikou_return"  ]
*seikou_skip

[playse  volume="100"  time="0"  buf="0"  storage="job_seikou.mp3"  ]
[chara_hide  name="job"  time="0"  wait="false"  pos_mode="false"  ]
[chara_show  name="job"  time="0"  wait="true"  storage="chara/169/job_kintore2.png"  width="496"  height="280"  left="368"  top="165"  ]
[wait  time="500"  ]
[jump  storage="job_kintore.ks"  target="*seikou_return"  ]
*sippai_skip

[playse  volume="100"  time="0"  buf="0"  storage="job_sippai.mp3"  ]
[chara_hide  name="job"  time="0"  wait="false"  pos_mode="false"  ]
[chara_show  name="job"  time="0"  wait="true"  storage="chara/169/job_kintore1.png"  width="496"  height="280"  left="368"  top="165"  ]
[wait  time="500"  ]
[jump  storage="job_kintore.ks"  target="*sippai_return"  