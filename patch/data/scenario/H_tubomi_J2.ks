...
[jump  storage="H_tubomi_J2_2.ks"  target="*top"  cond="f.Hresult_kaihatuLV0_tubomi>999"  ]
...
;右４　撫でる
[button target=*4 enterimg=/H/HUI_atamanade.png clickimg=/H/HUI_atamanade_on.png x=928 y=16 graphic=/H/HUI_atamanade_on.png name="ui"]

;右5　素股
[button target=*5 enterimg=/H/HUI_sumata.png clickimg=/H/HUI_sumata_on.png x=840 y=16 graphic=/H/HUI_sumata_on.png name="ui"]

;右6　手コキ
[button target=*6 enterimg=/H/HUI_tekoki.png clickimg=/H/HUI_tekoki_on.png x=752 y=16 graphic=/H/HUI_tekoki_on.png name="ui"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ02_02_01_01.gif"  ]
[tb_start_tyrano_code]
;キスループパターン

[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_kiss_hit"]

[elsif exp="f.H_kiss == 0"]
[call storage=H_serihu_tubomi.ks target="*J2_kiss1"]

[elsif exp="f.H_kiss == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_kiss2"]

[elsif exp="f.H_kiss == 2"]
[call storage=H_serihu_tubomi.ks target="*J2_kiss3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ02_02_02_01.gif"  ]
[tb_start_tyrano_code]
;胸揉み_ループパターン

[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_munemomi_hit"]

[elsif exp="f.H_munemomi == 0"]
[call storage=H_serihu_tubomi.ks target="*J2_munemomi1"]

[elsif exp="f.H_munemomi == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_munemomi2"]

[elsif exp="f.H_munemomi == 2"]
[call storage=H_serihu_tubomi.ks target="*J2_munemomi3"]
...
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ02_02_03_03.gif"  ]
[tb_start_tyrano_code]
;乳首舐め_ループパターン

[if exp="f.H_hit == 5 && f.H_high3 == 1 "]
[call storage=H_serihu_tubomi.ks target="*J2_tikubiname_hit"]

[elsif exp="f.H_tikubiname == 0 "]
[call storage=H_serihu_tubomi.ks target="*J2_tikubiname1"]

[elsif exp="f.H_tikubiname == 1 "]
[call storage=H_serihu_tubomi.ks target="*J2_tikubiname2"]

[elsif exp="f.H_tikubiname == 2 "]
[call storage=H_serihu_tubomi.ks target="*J2_tikubiname3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ02_02_08_01.gif"  ]
[tb_start_tyrano_code]
;撫でる_ループパターン

[if exp="f.H_hit == 5 && f.H_high4 == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_naderu_hit"]

[elsif exp="f.H_naderu == 0 "]
[call storage=H_serihu_tubomi.ks target="*J2_naderu1"]

[elsif exp="f.H_naderu == 1 "]
[call storage=H_serihu_tubomi.ks target="*J2_naderu2"]

[elsif exp="f.H_naderu == 2 "]
[call storage=H_serihu_tubomi.ks target="*J2_naderu3"]
...
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  loop="true"  ]
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ02_02_20_01.gif"  ]
[tb_start_tyrano_code]
;素股_ループパターン

[if exp="f.H_hit == 5 && f.H_high5 == 1 "]
[call storage=H_serihu_tubomi.ks target="*J2_sumata_hit"]

[elsif exp="f.H_sumata == 0 "]
[call storage=H_serihu_tubomi.ks target="*J2_sumata1"]

[elsif exp="f.H_sumata == 1 "]
[call storage=H_serihu_tubomi.ks target="*J2_sumata2"]

[elsif exp="f.H_sumata == 2 "]
[call storage=H_serihu_tubomi.ks target="*J2_sumata3"]
...
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  loop="true"  ]
[stopse  time="1000"  buf="2"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ02_02_40_01.gif"  ]
[tb_start_tyrano_code]
;手コキループパターン

[if exp="f.H_hit == 5 && f.H_high6 == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_tekoki_hit"]

[elsif exp="f.H_tekoki == 0"]
[call storage=H_serihu_tubomi.ks target="*J2_tekoki1"]

[elsif exp="f.H_tekoki == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_tekoki2"]

[elsif exp="f.H_tekoki == 2"]
[call storage=H_serihu_tubomi.ks target="*J2_tekoki3"]
...
[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_tubomi.ks target="*J2_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_tubomi.ks target="*J2_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_tubomi.ks target="*J2_kaiwa3"]
...
[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_pisuton_yukkuri_hit"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 0"]
[call storage=H_serihu_tubomi.ks target="*J2_pisuton_yukkuri1"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_pisuton_yukkuri2"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 2"]
[call storage=H_serihu_tubomi.ks target="*J2_pisuton_yukkuri3"]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_tubomi_J2.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_pisuton_hagesiku_hit"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 0"]
[call storage=H_serihu_tubomi.ks target="*J2_pisuton_hagesiku1"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 1"]
[call storage=H_serihu_tubomi.ks target="*J2_pisuton_hagesiku2"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 2"]
[call storage=H_serihu_tubomi.ks target="*J2_pisuton_hagesiku3"]
...
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_tubomi_J2.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
...
[l  ]
[jump  storage="H_tubomi_J2.ks"  target="*end"  ]
...
[wait  time="1500"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_tubomi_J2.ks"  target="*syasei_nakadasi_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[stop_bgmovie  time="1000"  ]
