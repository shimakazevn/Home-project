...
[bg  time="0"  method="crossfade"  storage="H/HF01_03_00_00.gif"  ]
...
[playse storage="rinko/voice_j_rinko_kaisi1.mp3" buf="3"]Rinko「Đến đây... em cứ làm gì tùy thích đi... hãy làm cho chị rối tung lên đi♡」[p]
[_tb_end_text]
...
;右２　耳舐め
[button target=*2 enterimg=/H/HUI_miminame.png clickimg=/H/HUI_miminame_on.png x=1104 y=16 graphic=/H/HUI_miminame_on.png name="ui"]
...
[playse  volume="100"  time="1000"  buf="4"  storage="H_teman1.mp3"  loop="true"  clear="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HF01_03_04_01.gif"  ]
[tb_start_tyrano_code]
;手マン_ループパターン

[if exp="f.H_hit == 5 && f.H_high6 == 1"]
[call storage=H_serihu_rinko.ks target="*H1_teman_hit"]

[elsif exp="f.H_teman == 0 "]
[call storage=H_serihu_rinko.ks target="*H1_teman1"]

[elsif exp="f.H_teman == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_teman2"]

[elsif exp="f.H_teman == 2 "]
[call storage=H_serihu_rinko.ks target="*H1_teman3"]

[endif]
[_tb_end_tyrano_code]

[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[jump  storage="H_rinko_hajimete.ks"  target="*top2"  ]
*5

[cm  ]
[stopse  time="1000"  buf="3"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="4"  storage="H_teman1.mp3"  loop="true"  clear="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HF01_03_05_03.gif"  ]
[tb_start_tyrano_code]
;クンニ_ループパターン

[if exp="f.H_hit == 5 && f.H_high5 == 1"]
[call storage=H_serihu_rinko.ks target="*H1_kunni_hit"]

[elsif exp="f.H_kunni == 0 "]
[call storage=H_serihu_rinko.ks target="*H1_kunni1"]

[elsif exp="f.H_kunni == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_kunni2"]

[elsif exp="f.H_kunni == 2 "]
[call storage=H_serihu_rinko.ks target="*H1_kunni3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HF01_03_08_05.gif"  ]
[tb_start_tyrano_code]
;尻撫でループパターン

[if exp="f.H_hit == 5 && f.H_high4 == 1"]
[call storage=H_serihu_rinko.ks target="*H1_sirinade_hit"]

[elsif exp="f.H_sirinade == 0 "]
[call storage=H_serihu_rinko.ks target="*H1_sirinade1"]

[elsif exp="f.H_sirinade == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_sirinade2"]

[elsif exp="f.H_sirinade == 2 "]
[call storage=H_serihu_rinko.ks target="*H1_sirinade3"]
...
[stopse  time="1000"  buf="3"  fadeout="true"  ]
[stopse  time="1000"  buf="4"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HF01_03_02_01.gif"  ]
[tb_start_tyrano_code]
;胸揉み_ループパターン

[if exp="f.H_hit == 5 && f.H_high3 == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_munemomi_hit"]

[elsif exp="f.H_munemomi == 0 "]
[call storage=H_serihu_rinko.ks target="*H1_munemomi1"]

[elsif exp="f.H_munemomi == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_munemomi2"]

[elsif exp="f.H_munemomi == 2 "]
[call storage=H_serihu_rinko.ks target="*H1_munemomi3"]
...
[stopse  time="1000"  buf="3"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="4"  storage="H_teman1.mp3"  loop="true"  clear="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HF01_03_07_01.gif"  ]
[tb_start_tyrano_code]
;耳舐め_ループパターン

[if exp="f.H_hit == 5 && f.H_high2 == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_miminame_hit"]

[elsif exp="f.H_miminame == 0 "]
[call storage=H_serihu_rinko.ks target="*H1_miminame1"]

[elsif exp="f.H_miminame == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_miminame2"]

[elsif exp="f.H_miminame == 2 "]
[call storage=H_serihu_rinko.ks target="*H1_miminame3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HF01_03_01_01.gif"  ]
[tb_start_tyrano_code]
;キス_ループパターン

[if exp="f.H_hit == 5 && f.H1 == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_kiss_hit"]

[elsif exp="f.H_kiss == 0 "]
[call storage=H_serihu_rinko.ks target="*H1_kiss1"]

[elsif exp="f.H_kiss == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_kiss2"]

[elsif exp="f.H_kiss == 2 "]
[call storage=H_serihu_rinko.ks target="*H1_kiss3"]
...
[stopse  time="1000"  buf="3"  fadeout="true"  ]
[stopse  time="1000"  buf="4"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HF01_03_00_01.gif"  ]
[tb_start_tyrano_code]
;会話_ループパターン

[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_rinko.ks target="*H1_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_rinko.ks target="*H1_kaiwa3"]
...
[cm  ]
[jump  storage="H_rinko_hajimete.ks"  target="*sounyu_skip"  cond="f.H_sounyu==1"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[tb_start_text mode=1 ]
[playse storage="rinko/voice_j0_rinko_sou1.mp3" buf="3"]Rinko「Đến đây... không cần phải khách sáo đâu, đút vào tận sâu bên trong đi em? Chị muốn được lấp đầy nhanh lên.」[p]
[舜]「Chị Rinko, em...」[p]
[playse storage="rinko/voice_j0_rinko_sou2.mp3" buf="3"]Rinko「Đút vào đây này... em hiểu chứ? Hãy đút con cu đang to lên vào đi...♡」[p]
[舜]「Hà, hà... em đút vào đây...! Khốn, ưmmm!」[p]
[playse storage="rinko/voice_j0_rinko_sou3.mp3" buf="3"]Rinko「Aaaa♡ To quá... bên trong, bị nong rộng ra mất thôiii♡」[p]
[_tb_end_text]
...
[call storage="H_rinko_cam.ks" target=*H1_cam1_yukkuri]
[elsif exp="f.H_pisutonspeed== 1"]
[call storage="H_rinko_cam.ks" target=*H1_cam1_hagesiku]
[endif]
...
;スピード別の画像を表示
[if exp="f.H_pisutonspeed== 0"]
[call storage="H_rinko_cam.ks" target=*H1_cam2_yukkuri]
[elsif exp="f.H_pisutonspeed== 1"]
[call storage="H_rinko_cam.ks" target=*H1_cam2_hagesiku]
[endif]
...
[call storage=H_serihu_rinko.ks target="*H1_pisuton_yukkuri_hit"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 0"]
[call storage=H_serihu_rinko.ks target="*H1_pisuton_yukkuri1"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 1"]
[call storage=H_serihu_rinko.ks target="*H1_pisuton_yukkuri2"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 2"]
[call storage=H_serihu_rinko.ks target="*H1_pisuton_yukkuri3"]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_rinko_hajimete.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
[if exp="f.H_hit == 5 && f.H_high1 == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_pisuton_hagesiku_hit"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 0 "]
[call storage=H_serihu_rinko.ks target="*H1_pisuton_hagesiku1"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 1 "]
[call storage=H_serihu_rinko.ks target="*H1_pisuton_hagesiku2"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 2 "]
[call storage=H_serihu_rinko.ks target="*H1_pisuton_hagesiku3"]
...
[cm  ]
[tb_start_text mode=1 ]
[舜]「Sắp... ra rồi...! Em bắn lên người chị Rinko được không...!」[p]
Rinko「Hà♡ A♡ Tất nhiên rồi♡ Hãy bắn thứ đặc sệt lên đi... chị muốn được lấp đầy bằng mùi của Shun-kun♡」[p]
Rinko「Hãy làm cho khắp cơ thể chị, dính đầy tinh dịch của Shun-kun đi...」[p]
[舜]「Hà, hà, ra đây...! Ưmaaaa!」[p]
[_tb_end_text]
...
[stopse  time="1000"  buf="4"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_rinko_hajimete.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_syasei.mp3"  ]
[bg  time="0"  method="crossfade"  storage="H/HF01_03_G3.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Rinko「Ưm...♡ Hà, hà... em bắn ra nhiều thật đấy... ngập tràn mùi của Shun-kun rồi...」[p]
Rinko「Khc, ấm quá... có phải vì nó đặc sệt lắm không nhỉ?」[p]
Rinko「Em đã nhịn suốt nãy giờ sao? Đừng khách sáo, cứ bắn ra thật nhiều cũng được mà.」[p]
[_tb_end_text]

[tb_eval  exp="sf.Hresult_bukkake_rinko+=1"  name="Hresult_bukkake_rinko"  cmd="+="  op="t"  val="1"  ]
[l  ]
[jump  storage="H_rinko_hajimete.ks"  target="*end"  ]
*syasei_karada_tairyou

[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_syasei.mp3"  ]
[bg  time="0"  method="crossfade"  storage="H/HF01_03_G4.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Rinko「Aaaan♡ Khắp cơ thể... dính đầy tinh dịch rồi...♡ Hà, hà... lượng nhiều quá...♡」[p]
Rinko「Hơn nữa mùi nồng nặc quá nhỉ... chị sắp chóng mặt đến nơi rồi...♡」[p]
Rinko「Vì mùi hương của Shun-kun, mà tử cung chị cứ nhói lên liên hồi...♡」[p]
[_tb_end_text]
...
[cm  ]
[tb_start_text mode=1 ]
Rinko「Hà♡ Hà♡ Hà♡ Con cu, đang giật giật kìa... em lại sắp ra nữa sao?」[p]
Rinko「Đừng khách sáo... em bắn vào trong cũng được mà... Nào, cho chị tất cả tình cảm nóng bỏng của Shun-kun đi♡」[p]
[舜]「Được sao...? Hà, hà, ra đây...!」[p]
Rinko「Bắn đi em... cho chị vào trong đi...♡」[p]
[舜]「Ra... ra, ra đây... khốn... a, aaaa」[p]
[_tb_end_text]
...
[if exp="f.H_cam1_on == 1"]
[bg storage="H/HF01_03_90_99A.gif" time=1000]

[elsif exp="f.H_cam1_on == 0"]
[bg storage="H/HF01_03_90_99B.gif" time=1000]
...
[wait  time="1500"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_rinko_hajimete.ks"  target="*syasei_nakadasi_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[bg  time="0"  method="crossfade"  storage="H/HF01_03_G1.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Rinko「Aaaa♡ Ưm, khốn♡ Bắn ra rồi...♡ Đang giật giật kìa...♡」[p]
Rinko「Ưm... phù... em xuất tinh giỏi lắm... trong bụng chị, đầy ứ lên mất rồi...♡」[p]
Rinko「Khc, được lấp đầy bằng tinh dịch của Shun-kun, tận sâu bên trong ấm quá đi...♡」[p]
[_tb_end_text]
...
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[bg  time="0"  method="crossfade"  storage="H/HF01_03_G2.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Rinko「Hiaaa♡ A, vẫn, đang cử động bên trong... ưm♡ Phù, phù♡」[p]
Rinko「Nóng quá đi mất... an♡ Khoan đã, thôi mà... chị không chứa nổi nữa, đâuuu♡」[p]
Rinko「Bị rót vào nhiều thế này... thì có em bé mất thôi...♡ Làm sao đây♡」[p]
[_tb_end_text]
