...
[jump  storage="H_nagi_R3_2.ks"  target="*top"  cond="f.Hresult_kaihatuLV0_nagi>999"  ]
[mask  time="500"  effect="fadeIn"  color="0x000000"  ]
[chara_hide_all  time="0"  wait="true"  ]
[bg  time="0"  method="crossfade"  storage="H/HR03_01_00_00.gif"  ]
...
[playse storage="nagi/voice_r_nagi_kaisi3.mp3" buf="1"]Nagi「Cả trái tim lẫn cơ thể em đều là của anh Shun mà... anh cứ đối xử thế nào tùy thích đi...♡」[p]
[_tb_end_text]
...
;右１　スパンキング（胸）
[button target=*1 enterimg=/H/HUI_munetataki.png clickimg=/H/HUI_munetataki_on.png x=1192 y=16 graphic=/H/HUI_munetataki_on.png]
...
;右5　キス
[button target=*5 enterimg=/H/HUI_kiss0.png clickimg=/H/HUI_kiss0_on.png x=840 y=16 graphic=/H/HUI_kiss0_on.png name="ui"]

;右6　首絞め
[button target=*6 enterimg=/H/HUI_kubisime.png clickimg=/H/HUI_kubisime_on.png x=752 y=16 graphic=/H/HUI_kubisime_on.png name="ui"]
...
*kirikae_low
;ボタン切り替え（低）
[jump storage="H_nagi_R3.ks" target=*top2]

*kirikae_high
;ボタン切り替え（高）
[jump storage="H_nagi_R3_2.ks" target=*top2]
[_tb_end_tyrano_code]
...
[tb_start_tyrano_code]
;叩く（notloop）
[tb_image_show  time="1000"  storage="default/H/HR03_01_09_02.gif"]
[_tb_end_tyrano_code]
...
[call storage=H_serihu_nagi.ks target="*R3_supankingu_hit"]

[elsif exp="f.H_supankingu == 0"]
[call storage=H_serihu_nagi.ks target="*R3_supankingu1"]

[elsif exp="f.H_supankingu == 1"]
[call storage=H_serihu_nagi.ks target="*R3_supankingu2"]

[elsif exp="f.H_supankingu == 2"]
[call storage=H_serihu_nagi.ks target="*R3_supankingu3"]
...
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_02_01.gif"  ]
[tb_start_tyrano_code]
;胸揉み_ループパターン

[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_munemomi_hit"]

[elsif exp="f.H_munemomi == 0"]
[call storage=H_serihu_nagi.ks target="*R3_munemomi1"]

[elsif exp="f.H_munemomi == 1"]
[call storage=H_serihu_nagi.ks target="*R3_munemomi2"]

[elsif exp="f.H_munemomi == 2"]
[call storage=H_serihu_nagi.ks target="*R3_munemomi3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_03_01.gif"  ]
[tb_start_tyrano_code]
;乳首弄り_ループパターン

[if exp="f.H_hit == 5 && f.H_high3 == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_tikubiijiri_hit"]

[elsif exp="f.H_tikubiijiri == 0 "]
[call storage=H_serihu_nagi.ks target="*R3_tikubiijiri1"]

[elsif exp="f.H_tikubiijiri == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_tikubiijiri2"]

[elsif exp="f.H_tikubiijiri == 2 "]
[call storage=H_serihu_nagi.ks target="*R3_tikubiijiri3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_20_01.gif"  ]
[tb_start_tyrano_code]
;素股(腰振り)_ループパターン

[if exp="f.H_hit == 5 && f.H_high4 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_kosihuri_hit"]

[elsif exp="f.H_kosihuri == 0 "]
[call storage=H_serihu_nagi.ks target="*R3_kosihuri1"]

[elsif exp="f.H_kosihuri == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_kosihuri2"]

[elsif exp="f.H_kosihuri == 2 "]
[call storage=H_serihu_nagi.ks target="*R3_kosihuri3"]
...
[cm  ]
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="1"  storage="nagi/voice_r_nagi_kiss1.mp3"  loop="true"  clear="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_01_01.gif"  ]
[tb_start_tyrano_code]
;キスでループパターン

[if exp="f.H_hit == 5 && f.H_high5 == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_kiss_hit"]

[elsif exp="f.H_kiss == 0 "]
[call storage=H_serihu_nagi.ks target="*R3_kiss1"]

[elsif exp="f.H_kiss == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_kiss2"]

[elsif exp="f.H_kiss == 2 "]
[call storage=H_serihu_nagi.ks target="*R3_kiss3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_07_05.gif"  ]
[tb_start_tyrano_code]
;首絞めループパターン

[if exp="f.H_hit == 5 && f.H_high6 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_kubisime_hit"]

[elsif exp="f.H_kubisime == 0"]
[call storage=H_serihu_nagi.ks target="*R3_kubisime1"]

[elsif exp="f.H_kubisime == 1"]
[call storage=H_serihu_nagi.ks target="*R3_kubisime2"]

[elsif exp="f.H_kubisime == 2"]
[call storage=H_serihu_nagi.ks target="*R3_kubisime3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[stopse  time="1000"  buf="1"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HR03_01_00_01.gif"  ]
[tb_start_tyrano_code]
;会話_ループパターン

[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_nagi.ks target="*R3_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_nagi.ks target="*R3_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_nagi.ks target="*R3_kaiwa3"]
...
[cm  ]
[jump  storage="H_nagi_R3.ks"  target="*sounyu_skip"  cond="f.H_sounyu==1"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[tb_start_text mode=1 ]
[playse storage="nagi/voice_r3_1_nagi_sou1.mp3" buf="1"]Nagi「A, ưm♡ Sâu bên trong cơ thể... đang nóng ran lên rồi...♡」[p]
[playse storage="nagi/voice_r3_1_nagi_sou2.mp3" buf="1"]Nagi「Em đã chuẩn bị sẵn sàng để đón nhận con cu của anh Shun rồi... anh cứ vào lúc nào cũng được nhé♡」[p]
[舜]「Thế thì anh không khách sáo mà đút vào nhé.」[p]
[playse storage="nagi/voice_r3_1_nagi_sou3.mp3" buf="1"]Nagi「Anh cứ đút một mạch vào tận sâu bên trong đi... rồi dập hông thật mạnh vào nhé♡」[p]
[舜]「Khốn... ưmmm! A, ướt nhẹp hết cả rồi...!」[p]
[_tb_end_text]
...
[call  storage="H_nagi_gauge.ks"  target="*set"  ]
[call  storage="H_nagi_gazou.ks"  target="*R3_yukkuri_cam1"  ]
[tb_start_tyrano_code]
;ベース画像（挿入）
...
[call storage="H_nagi_cam.ks" target=*R3_cam1_yukkuri]
[elsif exp="f.H_pisutonspeed== 1"]
[call storage="H_nagi_cam.ks" target=*R3_cam1_hagesiku]
[endif]
...
;スピード別の画像を表示
[if exp="f.H_pisutonspeed== 0"]
[call storage="H_nagi_cam.ks" target=*R3_cam2_yukkuri]
[elsif exp="f.H_pisutonspeed== 1"]
[call storage="H_nagi_cam.ks" target=*R3_cam2_hagesiku]
[endif]
...
[call storage="H_nagi_gazou.ks" target="*R3_yukkuri_cam2"]
[endif]
...
[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_pisuton_yukkuri_hit"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 0"]
[call storage=H_serihu_nagi.ks target="*R3_pisuton_yukkuri1"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 1"]
[call storage=H_serihu_nagi.ks target="*R3_pisuton_yukkuri2"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 2"]
[call storage=H_serihu_nagi.ks target="*R3_pisuton_yukkuri3"]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_nagi_R3.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
;画像表示(激しく)
[if exp="f.H_cam1_on == 1"]
[call storage="H_nagi_gazou.ks" target="*R3_hagesiku_cam1"]
[elsif exp="f.H_cam1_on == 0"]
[call storage="H_nagi_gazou.ks" target="*R3_hagesiku_cam2"]
[endif]
[_tb_end_tyrano_code]
...
[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_nagi.ks target="*R3_pisuton_hagesiku_hit"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 0"]
[call storage=H_serihu_nagi.ks target="*R3_pisuton_hagesiku1"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 1"]
[call storage=H_serihu_nagi.ks target="*R3_pisuton_hagesiku2"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 2"]
[call storage=H_serihu_nagi.ks target="*R3_pisuton_hagesiku3"]
...
[cm  ]
[tb_start_text mode=1 ]
[舜]「A, sắp ra rồi...! Anh làm cho cơ thể Nagi dính đầy tinh dịch của anh có được không?」[p]
Nagi「Vâng...♡ Tràn ngập mùi của anh Shun thì em vui lắm... anh cứ bắn hết ra đi♡」[p]
[舜]「Bị dạy dỗ đàng hoàng rồi nhỉ... phải cho anh nghe tiếng vòi vĩnh tinh dịch chứ!」[p]
Nagi「Hãy bắn tinh dịch lên người em thật nhiều đi anh♡ Làm cho khắp cơ thể em dính nhem nhuốc đi...♡」[p]
[舜]「Khốn... ưm...! Ra đây...! Hà, a, aaaa!」[p]
[_tb_end_text]
...
[stopse  time="1000"  buf="3"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_nagi_R3.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_syasei.mp3"  ]
[stop_bgmovie  time="1000"  ]
[bg  time="0"  method="crossfade"  storage="H/HR03_01_G3.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Aaa♡ Thứ nóng hổi... đang bắn lên kìa... chỉ cần ngửi mùi thôi cũng biết là ra nhiều lắm rồi♡」[p]
Nagi「Tràn ngập... mùi của anh Shun rồi♡ Cảm ơn anh nhiều lắm♡」[p]
Nagi「Hôm nay toàn thân em cũng được trở thành đồ vật của anh Shun rồi...♡」[p]
[_tb_end_text]

[tb_eval  exp="sf.Hresult_bukkake_nagi+=1"  name="Hresult_bukkake_nagi"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[l  ]
[jump  storage="H_nagi_R3.ks"  target="*end"  ]
*syasei_karada_tairyou

[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_syasei.mp3"  ]
[stop_bgmovie  time="1000"  ]
[bg  time="0"  method="crossfade"  storage="H/HR03_01_G4.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Dính nhem nhuốc hết cả rồi...♡ Hơn nữa mùi đàn ông nồng nặc quá...♡」[p]
Nagi「Chỉ tắm trên da thôi... mà cứ như thụ tinh đến nơi rồi...♡ Ưm, em chẳng còn nghĩ được gì khác nữa.」[p]
Nagi「Cảm ơn anh vì đã làm cho em sướng nhé♡」[p]
[_tb_end_text]
...
[cm  ]
[tb_start_text mode=1 ]
[舜]「A, sắp ra rồi... Cứ thế này xả thẳng vào tận sâu bên trong luôn được đúng không?」[p]
Nagi「Vâng...♡ Hãy bắn thật nhiều đi anh...♡ Anh cứ rót vào bao nhiêu tùy thích...♡」[p]
Nagi「Cơ thể em... từ tận sâu bên trong đã là của anh Shun rồi... hãy lấp đầy bằng tinh dịch đi anh♡」[p]
[舜]「Biết nói hẳn hoi rồi đấy... Vậy thì đúng như ý muốn nhé...! Bắn hết đây!」[p]
[_tb_end_text]
...
[if exp="f.H_cam1_on == 1"]
[bg storage="H/HR03_01_90_99A.gif" time=1000]

[elsif exp="f.H_cam1_on == 0"]
[bg storage="H/HR03_01_90_99B.gif" time=1000]
...
[wait  time="1500"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_nagi_R3.ks"  target="*syasei_nakadasi_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[stop_bgmovie  time="1000"  ]
[bg  time="0"  method="crossfade"  storage="H/HR03_01_G1.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Ưm♡ Au♡ Con cu đang giật giật kìa...♡」[p]
Nagi「Sâu trong bụng... ấm quá♡ Aaaa♡ Bên trong đầy ứ lên rồi...♡」[p]
Nagi「Cảm ơn anh nhiều lắm♡ Hà, hà... phải làm sao để không bị trào ra mới được...♡」[p]
[_tb_end_text]
...
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
[stop_bgmovie  time="1000"  ]
[bg  time="0"  method="crossfade"  storage="H/HR03_01_G2.png"  ]
[wait  time="1500"  ]
[mask_off  time="4000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
Nagi「Hiu♡ A♡ Đang ra nhiều lắm♡ Bụng em, đầy ứ lên mất thôi♡」[p]
Nagi「Ưm... ực, ưm♡ Trào ra mất... tinh dịch hiếm hoi của anh Shun...」[p]
Nagi「Ưm... Chạm đến tận sâu nhất bên trong rồi... a... cả cơ thể cũng nóng ran lên rồi♡」[p]
[_tb_end_text]
