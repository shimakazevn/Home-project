tyrano.plugin.kag = {
    ...
    tmp: {
        ...
        angle: 0,
        three: {
            stat: {is_load: !1, canvas_show: !1, start_event: !0, scene_pm: {}, init_pm: {}, gyro: {pm: {}, x: 0, y: 0, enable: -1, mode: 0}},
            models: {},
            evt: {},
        },
    },
    stat: {
        ...
        qr: {mode: "off", define: {}},
        locate: {x: 0, y: 0},
        default_font: {color: "", bold: "", size: "", face: "", italic: "", edge: "", shadow: "", effect: "", effect_speed: ""},
        sysview: {save: "./tyrano/html/save.html", load: "./tyrano/html/load.html", backlog: "./tyrano/html/backlog.html", menu: "./tyrano/html/menu.html"},
        chara_pos_mode: "true",
        chara_effect: "swing",
        chara_ptext: "",
        chara_time: "600",
    ...
    init: function () {
        ...
        $("script").each(function () {
            $(this).attr("src") &&
                ((-1 == $(this).attr("src").indexOf("cordova") && -1 == $(this).attr("src").indexOf("phonegap")) || (that.define.FLAG_APRI = !0))
        })
    ...
    init_game: function () {
        ...
        var button_menu_obj = $(
            "<div class='button_menu' style='z-index:100000000'><img src='./tyrano/images/system/" + $.novel("file_button_menu") + "'  /></div>"
        )
