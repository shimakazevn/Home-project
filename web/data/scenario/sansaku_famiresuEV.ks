...
[glink  color="btn_03_black"  storage="sansaku_famiresuEV.ks"  size="20"  text="食べて帰る"  x="410"  y="200"  width="497"  height="57"  _clickable_img=""  target="*taberu"  ]
[glink  color="btn_03_black"  storage="sansaku_famiresuEV.ks"  size="20"  text="夜間のバイトをする（▲￥4000　▼体力）"  x="410"  y="280"  width="497"  height="57"  _clickable_img=""  target="*baito"  ]
[glink  color="btn_03_black"  storage="sansaku_hankagaiEV.ks"  size="20"  text="帰る"  x="410"  y="360"  width="497"  height="57"  _clickable_img=""  target="*kaeru"  ]
[s  ]
*baito
...
[glink  color="btn_03_black"  storage="sansaku_famiresuEV.ks"  size="20"  text="生ビール（テンション▲￥3000▼）"  x="330"  y="160"  width="636"  height="57"  _clickable_img=""  target="*mesi1"  ]
[glink  color="btn_03_black"  storage="sansaku_famiresuEV.ks"  size="20"  text="ハンバーガーセット（勇気▲テンション▲￥5000▼）"  x="330"  y="240"  width="636"  height="57"  _clickable_img=""  target="*mesi2"  ]
[glink  color="btn_03_black"  storage="sansaku_famiresuEV.ks"  size="20"  text="３ポンドステーキ（筋力▲テンション▲▲￥10000▼）"  x="330"  y="320"  width="636"  height="57"  _clickable_img=""  target="*mesi3"  ]
[glink  color="btn_03_black"  storage="sansaku_hankagaiEV.ks"  size="20"  text="やっぱり帰る"  x="330"  y="400"  width="636"  height="57"  _clickable_img=""  target="*kaeru"  ]
[s  ]
*mesi1
