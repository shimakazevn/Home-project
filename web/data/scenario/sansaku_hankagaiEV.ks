...
[舜]（Người đông như mọi khi, mệt thật đấy）[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
Tsubomi「Chỗ này, ngay gần khớp ngón chân... là khu phản xạ thần kinh thực vật đấy. Nếu cơ thể rối loạn thì sẽ khá đau đấy nhé」[p]
...
[glink  color="btn_03_black"  storage="sansaku_hankagaiEV.ks"  size="20"  text="Hủy bỏ"  x="415"  y="320"  width="497"  height="57"  _clickable_img=""  target="*yameru"  ]
[s  ]
*kuji
...
[call  storage="ui_parameter.ks"  target="*money_update"  ]
[tb_start_text mode=1 ]
[font color="yellow"]Cơ bắp tăng 10 điểm[resetfont][r][font color="yellow"]Đã thanh toán 5000 Yên[resetfont][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
（Với số tiền mang theo ngần này thì đúng là không đủ rồi）[p]
...
[tb_start_text mode=1 ]
（Cũng chẳng có gì đáng chú ý, mình không có việc gì ở đây cả）[p]
[_tb_end_text]
