...
[bg  time="0"  method="crossfade"  storage="komyu_insyou2.png"  cross="false"  ]
[call  storage="system.ks"  target="*fade_out"  ]
[call  storage="komyuhyouka_point_rinko.ks"  target="*top"  ]
[cm  ]
[tb_start_tyrano_code]
;ボタン表示（好き）
...
[tb_eval  exp="f.komyu_insyou_suki_rinko+=1"  name="komyu_insyou_suki_rinko"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[call  storage="komyuhyouka_point_rinko.ks"  target="*top"  ]
[tb_start_tyrano_code]
;ボタン表示（好き）戻る
...
[tb_eval  exp="f.komyu_insyou_suki_rinko-=1"  name="komyu_insyou_suki_rinko"  cmd="-="  op="t"  val="1"  val_2="undefined"  ]
[call  storage="komyuhyouka_point_rinko.ks"  target="*top"  ]
[jump  storage="komyuhyouka_rinko.ks"  target="*top"  ]
*kirai
...
[cm  ]
[chara_hide  name="komyu_hyouka"  time="0"  wait="true"  pos_mode="false"  ]
[tb_eval  exp="f.komyu_insyou_jyunsui_rinko+=1"  name="komyu_insyou_jyunsui_rinko"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[call  storage="komyuhyouka_point_rinko.ks"  target="*top"  ]
[tb_start_tyrano_code]
;ボタン表示（純粋）戻る
...
[tb_start_tyrano_code]
;ボタン表示（終了）
[button target=*syuuryou enterimg=komyu_end2.png clickimg=komyu_end.png  x=1088 y=620 graphic=komyu_end.png]
[_tb_end_tyrano_code]
