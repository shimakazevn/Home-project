...
[bg  time="0"  method="crossfade"  storage="komyu_insyou3.png"  ]
[call  storage="system.ks"  target="*fade_out"  ]
[call  storage="komyuhyouka_point_hayato.ks"  target="*top"  ]
[cm  ]
[tb_start_tyrano_code]
;ボタン表示（好き）
...
[tb_eval  exp="f.komyu_insyou_suki_hayato+=1"  name="komyu_insyou_suki_hayato"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[call  storage="komyuhyouka_point_hayato.ks"  target="*top"  ]
[tb_start_tyrano_code]
;ボタン表示（好き）戻る
...
[tb_eval  exp="f.komyu_insyou_suki_hayato-=1"  name="komyu_insyou_suki_hayato"  cmd="-="  op="t"  val="1"  val_2="undefined"  ]
[call  storage="komyuhyouka_point_hayato.ks"  target="*top"  ]
[jump  storage="komyuhyouka_hayato.ks"  target="*top"  ]
*kirai
...
[cm  ]
[chara_hide  name="komyu_hyouka"  time="0"  wait="true"  pos_mode="false"  ]
[tb_eval  exp="f.komyu_insyou_jyunsui_hayato+=1"  name="komyu_insyou_jyunsui_hayato"  cmd="+="  op="t"  val="1"  val_2="undefined"  ]
[call  storage="komyuhyouka_point_hayato.ks"  target="*top"  ]
[tb_start_tyrano_code]
;ボタン表示（純粋）戻る
