...
[bg  time="1000"  method="crossfade"  storage="H/HJ01_03_01_01.gif"  ]
[tb_start_tyrano_code]
;キスループパターン

[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_rinko.ks target="*J1_kiss_hit"]

[elsif exp="f.H_kiss == 0"]
[call storage=H_serihu_rinko.ks target="*J1_kiss1"]

[elsif exp="f.H_kiss == 1"]
[call storage=H_serihu_rinko.ks target="*J1_kiss2"]

[elsif exp="f.H_kiss == 2"]
[call storage=H_serihu_rinko.ks target="*J1_kiss3"]
...
[bg  time="2000"  method="crossfade"  storage="H/HJ01_03_60_01.gif"  ]
[tb_start_tyrano_code]
;パイズリ_ループパターン

[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_rinko.ks target="*J1_paizuri_hit"]

[elsif exp="f.H_paizuri == 0"]
[call storage=H_serihu_rinko.ks target="*J1_paizuri1"]

[elsif exp="f.H_paizuri == 1"]
[call storage=H_serihu_rinko.ks target="*J1_paizuri2"]

[elsif exp="f.H_paizuri == 2"]
[call storage=H_serihu_rinko.ks target="*J1_paizuri3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_03_02_01.gif"  ]
[tb_start_tyrano_code]
;胸揉み_ループパターン

[if exp="f.H_hit == 5 && f.H_high3 == 1 "]
[call storage=H_serihu_rinko.ks target="*J1_munemomi_hit"]

[elsif exp="f.H_munemomi == 0 "]
[call storage=H_serihu_rinko.ks target="*J1_munemomi1"]

[elsif exp="f.H_munemomi == 1 "]
[call storage=H_serihu_rinko.ks target="*J1_munemomi2"]

[elsif exp="f.H_munemomi == 2 "]
[call storage=H_serihu_rinko.ks target="*J1_munemomi3"]
...
[bg  time="1000"  method="crossfade"  storage="H/HJ01_03_02_03.gif"  ]
[tb_start_tyrano_code]
;胸舐め_ループパターン

[if exp="f.H_hit == 5 && f.H_high4 == 1"]
[call storage=H_serihu_rinko.ks target="*J1_munename_hit"]

[elsif exp="f.H_munename == 0 "]
[call storage=H_serihu_rinko.ks target="*J1_munename1"]

[elsif exp="f.H_munename == 1 "]
[call storage=H_serihu_rinko.ks target="*J1_munename2"]

[elsif exp="f.H_munename == 2 "]
[call storage=H_serihu_rinko.ks target="*J1_munename3"]
...
[stopse  time="1000"  buf="0"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  loop="true"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_03_05_03.gif"  ]
[tb_start_tyrano_code]
;クンニ_ループパターン

[if exp="f.H_hit == 5 && f.H_high5 == 1 "]
[call storage=H_serihu_rinko.ks target="*J1_kunni_hit"]

[elsif exp="f.H_kunni == 0 "]
[call storage=H_serihu_rinko.ks target="*J1_kunni1"]

[elsif exp="f.H_kunni == 1 "]
[call storage=H_serihu_rinko.ks target="*J1_kunni2"]

[elsif exp="f.H_kunni == 2 "]
[call storage=H_serihu_rinko.ks target="*J1_kunni3"]
...
[cm  ]
[stopse  time="1000"  buf="3"  fadeout="true"  ]
[playse  volume="100"  time="1000"  buf="0"  storage="H_teman1.mp3"  ]
[bg  time="1000"  method="crossfade"  storage="H/HJ01_03_04_01.gif"  ]
[tb_start_tyrano_code]
;手マンループパターン

[if exp="f.H_hit == 5 && f.H_high6 == 1"]
[call storage=H_serihu_rinko.ks target="*J1_teman_hit"]

[elsif exp="f.H_teman == 0"]
[call storage=H_serihu_rinko.ks target="*J1_teman1"]

[elsif exp="f.H_teman == 1"]
[call storage=H_serihu_rinko.ks target="*J1_teman2"]

[elsif exp="f.H_teman == 2"]
[call storage=H_serihu_rinko.ks target="*J1_teman3"]
...
[if exp="f.H_kaiwa == 0 "]
[call storage=H_serihu_rinko.ks target="*J1_kaiwa1"]

[elsif exp="f.H_kaiwa == 1 "]
[call storage=H_serihu_rinko.ks target="*J1_kaiwa2"]

[elsif exp="f.H_kaiwa == 2 "]
[call storage=H_serihu_rinko.ks target="*J1_kaiwa3"]
...
[if exp="f.H_hit == 5 && f.H_high1 == 1"]
[call storage=H_serihu_rinko.ks target="*J1_pisuton_yukkuri_hit"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 0"]
[call storage=H_serihu_rinko.ks target="*J1_pisuton_yukkuri1"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 1"]
[call storage=H_serihu_rinko.ks target="*J1_pisuton_yukkuri2"]

[elsif exp="f.H_supiritasu_pisuton_yukkuri == 2"]
[call storage=H_serihu_rinko.ks target="*J1_pisuton_yukkuri3"]
...
[tb_eval  exp="f.H_koudoukaisu+=1"  name="H_koudoukaisu"  cmd="+="  op="t"  val="1"  ]
[tb_eval  exp="f.H_pisutonspeed=0"  name="H_pisutonspeed"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[jump  storage="H_rinko_J1.ks"  target="*sounyu_top"  ]
*pituton_hagesiku
...
[if exp="f.H_hit == 5 && f.H_high2 == 1"]
[call storage=H_serihu_rinko.ks target="*J1_pisuton_hagesiku_hit"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 0"]
[call storage=H_serihu_rinko.ks target="*J1_pisuton_hagesiku1"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 1"]
[call storage=H_serihu_rinko.ks target="*J1_pisuton_hagesiku2"]

[elsif exp="f.H_supiritasu_pisuton_hagesiku == 2"]
[call storage=H_serihu_rinko.ks target="*J1_pisuton_hagesiku3"]
...
[stopse  time="1000"  buf="4"  fadeout="true"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_rinko_J1.ks"  target="*syasei_karada_tairyou"  cond="f.H_koudoukaisu>14"  ]
...
[l  ]
[jump  storage="H_rinko_J1.ks"  target="*end"  ]
...
[wait  time="1500"  ]
[bg  time="1000"  method="crossfade"  storage="black.jpg"  ]
[jump  storage="H_rinko_J1.ks"  target="*syasei_nakadasi_tairyou"  cond="f.H_koudoukaisu>14"  ]
[mask  time="1000"  effect="fadeIn"  color="0xffffff"  ]
